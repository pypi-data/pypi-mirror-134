...
class bulk_data_handler:
    ...
    def get_data_bulk(self, field_id,subject_id):
        """
        ...
        #tempdf = pd.read_csv("/media/tighu/extended_storage/ukb49570.csv", usecols=self.columns_to_read_for_field_id+['eid'])
        os.chdir('/home/tighu/PycharmProjects/UKBRepo/ukb/inputs/{}'.format(str_subject_id))
        os.system("git config remote.origin.annex-ignore false")
        os.chdir('/home/tighu/PycharmProjects/UKBRepo/ukb/inputs/')
        os.system("gnome-terminal -e 'bash -c \"datalad get {}; exec bash\"'".format(sting_for_datalad_command))


        return "/home/tighu/PycharmProjects/UKBRepo/ukb/inputs/"+str_subject_id


    def search_category_by_name(self,query):
