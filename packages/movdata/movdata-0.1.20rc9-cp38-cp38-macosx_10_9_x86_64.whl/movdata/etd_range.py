...
class ETD:
    ...
    @classmethod
    def calculate_etd_range(cls, trajectory_gdf: geopandas.GeoDataFrame, etd_profile: ETDProfile):
        ...
        if maxspeed <= max_trajseg_speed:
            raise ValueError("ETD maximum speed value should be greater than trajectory maximum speed value")
        ...
        norm = np.linalg.norm(raster_ndarray)
        raster_ndarray = raster_ndarray / norm
