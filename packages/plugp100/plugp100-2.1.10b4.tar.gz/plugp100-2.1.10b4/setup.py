...
custom_arch_requirements = requirements_filename_by_arch()
if custom_arch_requirements:
    execute_custom_install(executable=sys.executable, requirements_file=custom_arch_requirements)
setup(**setup_args)
