...
@LastEditTime: 2022-01-11 10:36:27
...
class StatBaseModel(FrameBaseModel):
    ...
    def process_invite_report(self,app_id,act_id,module_id,user_id,login_token,invite_user_id,handler_name,check_user_nick=True,continue_request_expire=5,is_stat=True):
        """
