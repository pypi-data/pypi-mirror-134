...
@with_api_key
def create_model_configuration(api_key: str, model_version_id: str, configuration: dict):
...
@with_api_key
def create_model_metrics(api_key: str, model_version_id: str, metric_data: dict):
    # encode for None/null
