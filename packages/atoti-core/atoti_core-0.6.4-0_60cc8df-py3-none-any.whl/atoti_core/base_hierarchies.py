...
from typing import Dict, Iterable, List, Mapping, Optional, Tuple, TypeVar

from .base_hierarchy import BaseHierarchyBound
from .coordinates import HierarchyKey
...
class BaseHierarchies(Mapping[Tuple[str, str], HierarchyT], ReprJsonable):
    ...
    def _multiple_hierarchies_error(
        key: HierarchyKey, hierarchies: Iterable[HierarchyT]
    ) -> KeyError:
