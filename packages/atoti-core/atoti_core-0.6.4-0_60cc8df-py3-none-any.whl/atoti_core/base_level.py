...
from .coordinates import LevelCoordinates, get_java_coordinates
...
class BaseLevel(ReprJsonable, BitwiseOperatorsOnly):
    ...
    def _java_description(self) -> str:
        ...
        return get_java_coordinates(self._coordinates)
    ...
    def __ne__(self, other: Any) -> NoReturn:  # type: ignore
