...
QUERY_ARGS_DOC = {
    ...
    "pretty": """* ``"pretty"`` is best for queries returning small results:
                ...
                * A :class:`~atoti_query.query_result.QueryResult` will be returned and its rows will be sorted according to the level comparators.""",
    ...
    "timeout": """timeout: The query timeout in seconds.""",
