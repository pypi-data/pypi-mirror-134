...
class WinOSClient:
    ...
    def __init__(
        ...
        self.logger = logger(__class__.__name__, enabled=logger_enabled, console=log_to_console)
    ...
    def __str__(self):
        return (f'Local host: {self.get_current_os_name_local()}\n'
                ...
                f'Logger enabled: {not self.logger.disabled}')
    ...
    def _client(self, command: str, ps: bool = False, cmd: bool = False, use_cred_ssp: bool = False, *args):
        ...
        # Catch exceptions
            ...
            self.logger.exception(f'Unhandled error: {err}. Try to use "run_cmd_local" method instead.')
            raise err
    ...
    def get_file_size_local(self, path: str) -> int:
        ...
        try:
            ...
            self.logger.exception(f'File [{path}] not found. {err}')
            raise err
    ...
    def get_xml_tree_local(self, path: str, tag: str = None):
        ...
        try:
            ...
            self.logger.exception(f'Failed to open file. {err}')
    ...
    def copy_local(self, source: str, destination: str, new_name: str = None) -> bool:
        ...
        try:
            ...
            self.logger.exception(f'ERROR occurred during file copy. {err}')
            raise err
    ...
    def get_service(self, name: str) -> json:
        ...
        try:
            ...
            self.logger.exception(f'Exit code: {result.exited}. {result.stderr}')
            return {}
