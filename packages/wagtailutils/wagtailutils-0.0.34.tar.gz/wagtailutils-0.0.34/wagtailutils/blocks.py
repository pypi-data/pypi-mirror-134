...
# class CollapsableStructBlock(blocks.StructBlock):
#     MUTABLE_META_ATTRIBUTES = ["collapsable", "collapsed_section_label"]
#     class Meta:
#         collapsable = []
#         collapsed_section_label = "More"
        
# class CollapsableStructBlockAdapter(StructBlockAdapter):
#     js_constructor = "pages.blocks.CollapsableStructBlock"

#     def js_args(self, block):
#         args = super().js_args(block)
#         args[-1]["collapsable"] = blocks.meta.collapsable
#         args[-1]["collapsed_section_label"] = blocks.meta.collapsed_section_label
#         return args
...
#         struct_block_media = super().media
#         return forms.Media(
#             js=struct_block_media._js + ["wagtailutils/js/collapsable_struct.js"],
#             css={
#                 "all": [
#                     "wagtailutils/css/collapsable_struct.css",
#                 ]
#             },
#         )
