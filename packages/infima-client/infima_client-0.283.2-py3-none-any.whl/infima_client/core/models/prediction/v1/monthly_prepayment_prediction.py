...
from infima_client.core.models.prediction.v1.prepayment_prediction_distrbution import (
    PredictionV1PrepaymentPredictionDistrbution,
)
...
class PredictionV1MonthlyPrepaymentPrediction:
    ...
    Attributes:
        ...
        distribution (Union[Unset, PredictionV1PrepaymentPredictionDistrbution]):
        factor_date (Union[Unset, CoreFactorDate]):
        smm (Union[Unset, float]):
    """

    cpr: Union[Unset, float] = UNSET
    distribution: Union[Unset, PredictionV1PrepaymentPredictionDistrbution] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_distribution, Unset):
            ...
            distribution = PredictionV1PrepaymentPredictionDistrbution.from_dict(
                _distribution
            )
