...
class Fiber():
    ...
    def xyFocalPlaneSAB(self, pixperrow):
        """
        :return east and up location in units of microns for Sciene IFU or background
        """
        idx = int(self.name[3:])
        ...
        # so far even row = index up = outwards, odd row = index up = inwards
        # Undo the meander by countin all columns inwards up
        if (row % 2) != 0 :
            idx = pixperrow - idx - 1
    ...
    def xyFocalPlaneP(self):
        """
        :return east and up location in units of microns for specphot fiber
        """
...
if __name__ == "__main__":
    ...
    if False:
        ...
        # there is one mandatory command line argument, the fiber name (like P1-5 or A1-10 or S3-50)
