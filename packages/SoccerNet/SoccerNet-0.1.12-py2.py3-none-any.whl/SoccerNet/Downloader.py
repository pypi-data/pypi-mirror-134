...
class SoccerNetDownloader(OwnCloudDownloader):
    ...
    def download(self, task, split=["train","valid","test","challenge"]):
        if task == "calibration":
            if "train" in split:
                print("This function should download train.zip for calibration - but train.zip was not uploaded on the server yet!")
            if "valid" in split:
                print("This function should download valid.zip for calibration - but valid.zip was not uploaded on the server yet!")
            if "test" in split:
                print("This function should download test.zip for calibration - but test.zip was not uploaded on the server yet!")
            if "challenge" in split:
                print("This function should download challenge.zip for calibration - but challenge.zip was not uploaded on the server yet!")
