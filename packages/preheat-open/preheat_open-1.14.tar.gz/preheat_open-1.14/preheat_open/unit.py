...
from .helpers import now, sanitise_datetime_input, time_resolution_aliases, timedelta
...
class Unit(object):
    ...
    def __populate_components(self, unit_data: Dict) -> None:
        components = []
        try:
