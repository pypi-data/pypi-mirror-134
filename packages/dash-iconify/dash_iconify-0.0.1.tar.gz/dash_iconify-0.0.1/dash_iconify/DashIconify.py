...
- width (number; optional):
    Icon width."""
    @_explicitize_args
    def __init__(self, color=Component.UNDEFINED, flip=Component.UNDEFINED, height=Component.UNDEFINED, icon=Component.UNDEFINED, id=Component.UNDEFINED, inline=Component.UNDEFINED, rotate=Component.UNDEFINED, style=Component.UNDEFINED, width=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'color', 'flip', 'height', 'icon', 'inline', 'rotate', 'style', 'width']
        self._type = 'DashIconify'
        self._namespace = 'dash_iconify'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'color', 'flip', 'height', 'icon', 'inline', 'rotate', 'style', 'width']
