...
def main():
    ...
    if len(sys.argv) > 2 and sys.argv[1] == 'run':
        ...
        # Write stdout and stderr if it has not been streamed (Not rendered as text or not using output file)
        if app.version.get('stdout_render_type') != 'text' or not app.version.get('main_output_file'):
