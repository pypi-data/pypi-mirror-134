...
import redis
import envx
inner_env = envx.read(file_name='redis.env')
con_info = {
    "host": inner_env['host'],
...
redis_host_default = inner_env.get('host', 'localhost')
redis_port_default = int(inner_env.get('port', '6379'))
redis_pwd_default = inner_env.get('password')
