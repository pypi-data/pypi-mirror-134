...
class TextToSpeech(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        outputFileCol (object): The location of the saved file as an HDFS compliant URI
    ...
    language = Param(Params._dummy(), "language", "The name of the language used for synthesis")
    
    locale = Param(Params._dummy(), "locale", "The locale of the input text")
    
    outputFileCol = Param(Params._dummy(), "outputFileCol", "The location of the saved file as an HDFS compliant URI")
    
    outputFormat = Param(Params._dummy(), "outputFormat", "The format for the output audio can be one of ArraySeq(Raw8Khz8BitMonoMULaw, Riff16Khz16KbpsMonoSiren, Audio16Khz16KbpsMonoSiren, Audio16Khz32KBitRateMonoMp3, Audio16Khz128KBitRateMonoMp3, Audio16Khz64KBitRateMonoMp3, Audio24Khz48KBitRateMonoMp3, Audio24Khz96KBitRateMonoMp3, Audio24Khz160KBitRateMonoMp3, Raw16Khz16BitMonoTrueSilk, Riff16Khz16BitMonoPcm, Riff8Khz16BitMonoPcm, Riff24Khz16BitMonoPcm, Riff8Khz8BitMonoMULaw, Raw16Khz16BitMonoPcm, Raw24Khz16BitMonoPcm, Raw8Khz16BitMonoPcm, Ogg16Khz16BitMonoOpus, Ogg24Khz16BitMonoOpus)")
    
    subscriptionKey = Param(Params._dummy(), "subscriptionKey", "the API key to use")
    
    text = Param(Params._dummy(), "text", "The text to synthesize")
    
    url = Param(Params._dummy(), "url", "Url of the service")
    
    voiceName = Param(Params._dummy(), "voiceName", "The name of the voice used for synthesis")
    ...
    def __init__(
        self,
        java_obj=None,
        errorCol="TextToSpeech_0a345637656b_errors",
        language=None,
        languageCol=None,
        locale=None,
        localeCol=None,
        ...
        self._setDefault(errorCol="TextToSpeech_0a345637656b_errors")
    ...
    def getVoiceName(self):
        ...
        Returns:
            voiceName: The name of the voice used for synthesis
        """
        return self.getOrDefault(self.voiceName)
