...
class TextSentimentSDK(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    disableServiceLogs = Param(Params._dummy(), "disableServiceLogs", "disableServiceLogs option")
    
    errorCol = Param(Params._dummy(), "errorCol", "column to hold http errors")
    
    includeOpinionMining = Param(Params._dummy(), "includeOpinionMining", "includeOpinionMining option")
    
    includeStatistics = Param(Params._dummy(), "includeStatistics", "includeStatistics option")
    
    language = Param(Params._dummy(), "language", "the language code of the text (optional for some services)")
    
    modelVersion = Param(Params._dummy(), "modelVersion", "modelVersion option")
    ...
    def getDisableServiceLogs(self):
        ...
        Returns:
            disableServiceLogs: disableServiceLogs option
        """
        return self.getOrDefault(self.disableServiceLogs)
    ...
    def getIncludeOpinionMining(self):
        ...
        Returns:
            includeOpinionMining: includeOpinionMining option
        """
        return self.getOrDefault(self.includeOpinionMining)
    ...
    def getIncludeStatistics(self):
        ...
        Returns:
            includeStatistics: includeStatistics option
        """
        return self.getOrDefault(self.includeStatistics)
