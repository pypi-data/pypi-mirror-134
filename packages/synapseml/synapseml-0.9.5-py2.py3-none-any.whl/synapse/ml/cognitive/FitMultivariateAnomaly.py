...
class FitMultivariateAnomaly(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    """
    Args:
        alignMode (object): An optional field, indicates how we align different variables into the same time-range which is required by the model.{Inner, Outer}
        ...
        displayName (object): optional field, name of the model
        ...
        fillNAMethod (object): An optional field, indicates how missed values will be filled with. Can not be set to NotFill, when alignMode is Outer.{Previous, Subsequent, Linear, Zero, Fixed}
    ...
    alignMode = Param(Params._dummy(), "alignMode", "An optional field, indicates how we align different variables into the same time-range which is required by the model.{Inner, Outer}")
    ...
    displayName = Param(Params._dummy(), "displayName", "optional field, name of the model")
    ...
    fillNAMethod = Param(Params._dummy(), "fillNAMethod", "An optional field, indicates how missed values will be filled with. Can not be set to NotFill, when alignMode is Outer.{Previous, Subsequent, Linear, Zero, Fixed}")
    ...
    def __init__(
        ...
        endTime=None,
        endpoint=None,
        errorCol="FitMultivariateAnomaly_e6b1332b5634_error",
        fillNAMethod=None,
        initialPollingDelay=300,
        inputCols=None,
        intermediateSaveDir=None,
        maxPollingRetries=1000,
        outputCol="FitMultivariateAnomaly_e6b1332b5634_output",
        paddingValue=None,
        pollingDelay=300,
        sasToken=None,
        slidingWindow=None,
        ...
        self._setDefault(errorCol="FitMultivariateAnomaly_e6b1332b5634_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="FitMultivariateAnomaly_e6b1332b5634_output")
