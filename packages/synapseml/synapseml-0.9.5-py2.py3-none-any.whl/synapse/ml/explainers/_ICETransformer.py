...
class _ICETransformer(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        kind (object): Whether to return the partial dependence plot (PDP) averaged across all the samples in the dataset or individual feature importance (ICE) per sample. Allowed values are "average" for PDP and "individual" for ICE.
    ...
    kind = Param(Params._dummy(), "kind", "Whether to return the partial dependence plot (PDP) averaged across all the samples in the dataset or individual feature importance (ICE) per sample. Allowed values are \"average\" for PDP and \"individual\" for ICE.")
    ...
    def setKind(self, value):
        """
        Args:
            kind: Whether to return the partial dependence plot (PDP) averaged across all the samples in the dataset or individual feature importance (ICE) per sample. Allowed values are "average" for PDP and "individual" for ICE.
        """
