...
class AddressGeocoder(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    address = Param(Params._dummy(), "address", "the address to geocode")
    ...
    def __init__(
        ...
        errorCol="AddressGeocoder_c91ec072b714_error",
        initialPollingDelay=300,
        maxPollingRetries=1000,
        outputCol="AddressGeocoder_c91ec072b714_output",
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AddressGeocoder_c91ec072b714_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AddressGeocoder_c91ec072b714_output")
    ...
    def getAddress(self):
        ...
        Returns:
            address: the address to geocode
        """
        return self.getOrDefault(self.address)
