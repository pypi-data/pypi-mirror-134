...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    latitude = Param(Params._dummy(), "latitude", "the latitude of location")
    
    longitude = Param(Params._dummy(), "longitude", "the longitude of location")
    ...
    userDataIdentifier = Param(Params._dummy(), "userDataIdentifier", "the identifier for the user uploaded data")
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_4f8abcef55d7_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_4f8abcef55d7_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_4f8abcef55d7_error")
        self._setDefault(outputCol="CheckPointInPolygon_4f8abcef55d7_output")
    ...
    def getLatitude(self):
        ...
        Returns:
            latitude: the latitude of location
        """
        return self.getOrDefault(self.latitude)
    ...
    def getLongitude(self):
        ...
        Returns:
            longitude: the longitude of location
        """
        return self.getOrDefault(self.longitude)
    ...
    def getUserDataIdentifier(self):
        ...
        Returns:
            userDataIdentifier: the identifier for the user uploaded data
        """
        return self.getOrDefault(self.userDataIdentifier)
