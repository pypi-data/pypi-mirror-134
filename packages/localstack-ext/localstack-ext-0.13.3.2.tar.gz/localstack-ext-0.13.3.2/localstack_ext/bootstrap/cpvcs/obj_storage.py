...
class StateFileLocator(abc.ABC):
 location="_none_"
 active_instance=JPtXu
 @abc.abstractmethod
 def get_state_file_location_by_key(self,key:JPtXI)->JPtXI:
  pass
 @JPtXa
 def get(cls,requested_file_locator:JPtXI):
...
class ObjectStorageProvider(abc.ABC):
 ...
 active_instance=JPtXu
 @JPtXa
 def get(cls,state_file_locator:JPtXI,requested_storage:JPtXI,serializers:Dict[JPtXI,CPVCSSerializer]):
  ...
  return cls.active_instance
 def __init__(self,state_file_locator:StateFileLocator,serializers:Dict[JPtXI,CPVCSSerializer]):
 ...
 def get_state_file_location_by_key(self,key:JPtXI)->JPtXI:
  pass
 @abc.abstractmethod
 def get_version_by_key(self,key:JPtXI)->Version:
  pass
 @abc.abstractmethod
 def get_revision_by_key(self,key:JPtXI)->Revision:
  pass
 @abc.abstractmethod
 def get_revision_or_version_by_key(self,key:JPtXI)->Union[Revision,Version]:
  pass
 @abc.abstractmethod
 def get_delta_file_by_key(self,key:JPtXI)->JPtXI:
  pass
 @abc.abstractmethod
 def upsert_objects(self,*args:CPVCSObj)->List[JPtXI]:
  pass
 @abc.abstractmethod
 def update_revision_key(self,old_key:JPtXI,new_key:JPtXI,referenced_by_version:JPtXI=JPtXu):
  pass
 @abc.abstractmethod
 def version_exists(self,key:JPtXI)->JPtXR:
  pass
 @abc.abstractmethod
 def merge_remote_into_local_version(self,remote_location:JPtXI,key:JPtXI):
  pass
 @abc.abstractmethod
 def _update_key(self,old_key:JPtXI,new_key:JPtXI,base_path:JPtXI)->JPtXR:
  pass
 @abc.abstractmethod
 def _serialize(self,*args:CPVCSObj)->List[JPtXI]:
  pass
 @abc.abstractmethod
 def _deserialize(self,key_serializer:Dict[JPtXI,JPtXI],remote_location:JPtXI=JPtXu)->List[CPVCSObj]:
  pass
class ObjectStorageLocal(ObjectStorageProvider):
 ...
 def _serialize(self,*args:CPVCSObj)->List[JPtXI]:
  ...
  for cpvcs_obj in args:
   if JPtXM(cpvcs_obj,Version):
    hash_refs.append(self.serializers["version"].store_obj(cpvcs_obj))
   elif JPtXM(cpvcs_obj,Revision):
    hash_refs.append(self.serializers["revision"].store_obj(cpvcs_obj))
  return hash_refs
 def _deserialize(self,key_serializer:Dict[JPtXI,JPtXI],remote_location:JPtXI=JPtXu)->List[Union[Revision,Version]]:
