...
class CPVCSMergeManager(SubtypesInstanceManager):
 @Xjnkd
 def _is_special_case(obj)->XjnkM:
  return Xjnko(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:XjnkY,to_state_files):
  raise XjnkL("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:XjnkY,from_state_files:XjnkY,to_state_files:XjnkY):
  raise XjnkL("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:XjnkY)->Dict[XjnkY,XjnkY]:
