...
class CPVCSMergeManager(SubtypesInstanceManager):
 @fBREH
 def _is_special_case(obj)->fBREb:
  return fBREp(obj,(Queue,FakeBucket))
 def two_way_merge(self,from_state_files:fBREK,to_state_files):
  raise fBREU("Not implemented")
 def three_way_merge(self,common_ancestor_state_files:fBREK,from_state_files:fBREK,to_state_files:fBREK):
  raise fBREU("Not implemented")
...
def create_tmp_archives_by_serialization_mechanism(archive_dir:fBREK)->Dict[fBREK,fBREK]:
