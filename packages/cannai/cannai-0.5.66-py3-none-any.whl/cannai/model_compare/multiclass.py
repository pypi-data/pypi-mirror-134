    ...
    for tl1 in target_label:
        ...
        if key_list_add != []:
            ...
            if c_type == "b":
                ...
                score_out = C_mod.Cal_s.cal_score_multiple_2d(key_list, target_line, e_score_list, addtional_model=False)
                ...
                score_out = C_mod.Cal_s.cal_score_multiple_2d(key_list, target_line, e_score_list, addtional_model=True)
