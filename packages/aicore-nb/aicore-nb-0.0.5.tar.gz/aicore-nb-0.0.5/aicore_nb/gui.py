...
class Window(QWidget):
    ...
    def __init__(self,
        ...
        ###############################################################################
        # The next lines allow the user to change the name of the notebook              #
        #                                                                               #
        ################################################################################
        # label_name = QLabel()
        ...
        # self.notebook_name.setText("Question")
...
def create_gui(token: str, pathway:str='Essentials'):
