...
#        self.momentum_module_path =self.cfg['momentum_module']['path']
        self.fini_obj = self.cfg['multicharts']['fini_table']
        self.fini_file = self.cfg['multicharts']['fini_file']
        self.top10_obj = self.cfg['multicharts']['top10_table']
        self.top10_file = self.cfg['multicharts']['top10_file']
        self.fini_entry_obj = self.cfg['multicharts']['fini_entry']
...
def sendMessage(msg):
    token = os.environ.get("Line_Authorization")
    headers = {
