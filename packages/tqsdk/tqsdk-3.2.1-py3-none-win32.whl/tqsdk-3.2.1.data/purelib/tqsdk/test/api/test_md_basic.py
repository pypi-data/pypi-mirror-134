...
class TestMdBasic(TQBaseTestcase):
    ...
    def test_get_kline_serial_adj_type(self):
        ...
        self.assertAlmostEquals(klines2.iloc[-100].open, 2.57, places=4)
        self.assertAlmostEquals(klines2.iloc[-100].high, 2.59, places=4)
        self.assertAlmostEquals(klines2.iloc[-100].low, 2.55, places=4)
        self.assertAlmostEquals(klines2.iloc[-100].close, 2.58, places=4)
        ...
        self.assertAlmostEquals(klines3.iloc[-1].open, 2.53, places=4)
        self.assertAlmostEquals(klines3.iloc[-1].high, 2.57, places=4)
        self.assertAlmostEquals(klines3.iloc[-1].low, 2.51, places=4)
        self.assertAlmostEquals(klines3.iloc[-1].close, 2.55, places=4)
        ...
        self.assertAlmostEquals(klines4.iloc[-100].open, 2.48, places=4)
        self.assertAlmostEquals(klines4.iloc[-100].high, 2.48, places=4)
        self.assertAlmostEquals(klines4.iloc[-100].low, 2.46, places=4)
        self.assertAlmostEquals(klines4.iloc[-100].close, 2.47, places=4)
