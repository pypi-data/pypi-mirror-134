...
class TestGetDividendCoeff(unittest.TestCase):
    ...
    def test_get_dividend_df(self):
        ...
        pandas.testing.assert_series_equal(dt, df["datetime"], check_less_precise=True, check_names=False)
        pandas.testing.assert_series_equal(stock_dividend, df["stock_dividend"], check_less_precise=True, check_names=False)
        pandas.testing.assert_series_equal(cash_dividend, df["cash_dividend"], check_less_precise=True, check_names=False)
    ...
    def test_get_dividend_factor(self):
        ...
        self.assertAlmostEquals(0.9960788158023723, factor)
        factor = get_dividend_factor(
            df,
        ...
        self.assertAlmostEquals(0.9973342219260246, factor)
        factor = get_dividend_factor(
            df,
        ...
        self.assertAlmostEquals(0.49924976742790267, factor)
