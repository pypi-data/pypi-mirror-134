...
picard CreateSequenceDictionary R={humRef} O={humRef.replace('.fa','.dict')}
picard CreateSequenceDictionary R={virRef} O={virRef.replace('.fa','.dict')}
picard CreateSequenceDictionary R={newRef} O={newRef.replace('.fa','.dict')}
''')
    return None
