...
samtools sort -o {sitePath}/{site}.contig.sort.bam {sitePath}/{site}.contig.bam;
...
samtools sort -o {sitePath}/{site}.contigToGenome.sort.bam {sitePath}/{site}.contigToGenome.bam;
...
samtools sort -o {sitePath}/{site}.contigToVirus.sort.bam {contigPath}/{site}.contigToVirus.bam;
