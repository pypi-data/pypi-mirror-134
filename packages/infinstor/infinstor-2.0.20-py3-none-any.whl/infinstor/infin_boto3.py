...
class InfinBotoResource():
    def __init__(self, defaultResource, input_spec):
        self.defaultResource = defaultResource
        self.input_spec = input_spec
        self.bucketscollection = BucketsCollection(input_spec['bucketlist'])
        self.s3_resource_meta = S3ResourceMeta(self.defaultResource.meta,
                InfinBotoClient(defaultResource.meta.client, input_spec, None, None))
    ...
    def wrapper(*args, **kwargs):
        if 'infinstor_time_spec' in kwargs:
            ...
            if bucketlist:
                ...
                return InfinBotoResource(defaultResource, input_spec)
        defaultResource = orig_func(*args, **kwargs)
