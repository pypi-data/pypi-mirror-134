...
class ExcelWriter:
    ...
    def _header(self):
        ...
        worksheet.write(4, 0, 'To run the scanner with help: "hmcscanner --help"')
        worksheet.write(5, 0, 'Sample scanning of a single HMC: "hmcscanner --hmc <HMC name or IP> --user hscroot --pwd <the password>')
