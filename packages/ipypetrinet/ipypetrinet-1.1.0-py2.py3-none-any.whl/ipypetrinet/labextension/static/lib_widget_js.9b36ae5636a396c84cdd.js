...
class PetriView extends base_1.DOMWidgetView {
    render() {
        ...
        attrPopupContent.append(tabBar, attrName, div0, staticValue, div1, mue, sigma, div2, n, p, div3, k, theta, div4, beta, caseTabContent, eventTabContent);
        ...
        this.el.append(dropdown, saveGraph, importJSON, saveIMG, downloadJSON, zoomIn, zoomOut, addPlace, addTrans, addToken, removeToken, removeCell, clearAll, lockModel, simulate, stopSimulation, reloadSim, addAttrs);
