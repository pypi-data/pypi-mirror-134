...
def show_response_card(gs_context,current_context,response_details):
    ...
    print('15451',i18n_required,gs_context["slots"]['language'],gs_context['menu_handled'])
    if(i18n_required): #and gs_context["menu_handled"] == False:
        response_details = i18n_translate(response_details,gs_context["slots"]['language'],channel)
