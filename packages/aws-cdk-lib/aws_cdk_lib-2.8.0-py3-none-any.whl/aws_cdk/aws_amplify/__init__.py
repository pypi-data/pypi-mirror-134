...
class CfnApp(
    ...
    def __init__(
        ...
        *,
        ...
        :param basic_auth_config: The credentials for basic authorization for an Amplify app.
...
class CfnBranch(
    ...
    def __init__(
        ...
        *,
        ...
        :param basic_auth_config: The basic authorization credentials for a branch of an Amplify app.
