...
class CfnLogging(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param account_id: The unique identifier of the account to use when writing to CloudWatch logs.
        :param default_log_level: The logging level. Valid values are ``DEBUG`` , ``INFO`` , ``ERROR`` , ``WARN`` , and ``DISABLED`` .
...
class CfnResourceSpecificLogging(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param log_level: The logging level. Valid values are ``DEBUG`` , ``INFO`` , ``ERROR`` , ``WARN`` , and ``DISABLED`` .
        :param target_name: The log target name.
        :param target_type: The log target type.
        '''
