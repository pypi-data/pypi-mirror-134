...
class CfnNodegroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param ami_type: The AMI type for your node group. The following values are examples:. - ``AL2_x86_64`` – Use for Amazon Linux 2 non-GPU instances. - ``AL2_x86_64_GPU`` – Use for Amazon Linux 2 GPU instances. - ``AL2_ARM_64`` – Use for Amazon Linux 2 Arm instances. - ``CUSTOM`` – Use when specifying a custom AMI ID with a launch template. For more information, see `Specifying an AMI <https://docs.aws.amazon.com/eks/latest/userguide/launch-templates.html#launch-template-custom-ami>`_ in the *Amazon EKS User Guide* . - ``BOTTLEROCKET_ARM_64`` – Use for Bottlerocket Arm instances. - ``BOTTLEROCKET_x86_64`` – Use for Bottlerocket x86_64 instances. If you specify ``launchTemplate`` , and your launch template uses a custom AMI, then don't specify ``amiType`` , or the node group deployment will fail. For more information about using launch templates with Amazon EKS, see `Launch template support <https://docs.aws.amazon.com/eks/latest/userguide/launch-templates.html>`_ in the *Amazon EKS User Guide* .
    ...
    def ami_type(self) -> typing.Optional[builtins.str]:
        ...
        - ``CUSTOM`` – Use when specifying a custom AMI ID with a launch template. For more information, see `Specifying an AMI <https://docs.aws.amazon.com/eks/latest/userguide/launch-templates.html#launch-template-custom-ami>`_ in the *Amazon EKS User Guide* .
