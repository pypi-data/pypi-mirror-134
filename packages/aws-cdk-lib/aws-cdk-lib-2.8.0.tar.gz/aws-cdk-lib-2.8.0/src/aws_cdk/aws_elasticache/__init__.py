    ...
    class LogDeliveryConfigurationRequestProperty:
        def __init__(
            ...
            *,
            ...
            :param log_type: Valid value is ``slow-log`` . Refers to `slow-log <https://docs.aws.amazon.com/https://redis.io/commands/slowlog>`_ .
        ...
        def log_type(self) -> builtins.str:
            ...
            Refers to `slow-log <https://docs.aws.amazon.com/https://redis.io/commands/slowlog>`_ .
