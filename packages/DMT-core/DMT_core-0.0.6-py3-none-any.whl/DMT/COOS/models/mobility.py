""" Implementation of COOS's mobility model for non-alloy semiconductors in Python
"""
...
def get_mobility(mat, valley, eabs, dop, temp, velo=None):
    """return COOS mobility for material mat, in valley at field eabs, doping dop and temperature temp.
