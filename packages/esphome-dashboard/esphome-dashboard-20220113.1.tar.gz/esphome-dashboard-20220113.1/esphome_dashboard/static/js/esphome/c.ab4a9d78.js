...
`;let te=class extends y{constructor(){super(...arguments),this._busy=!1,this._board="ESP32",this._hasWifiSecrets=void 0,this._customBoard="",this._data={ssid:`!secret ${P}`,psk:`!secret ${x}`},this._state=O?"basic_config":"ask_esphome_web",this._installed=!1,this._cleanNameInput=e=>{this._error=void 0;const o=e.target;o.value=o.value.toLowerCase().replace(/[ \._]/g,"-").replace(/[^a-z0-9-]/g,"")},this._cleanNameBlur=e=>{const o=e.target;o.value=o.value.replace(/^-+/,"").replace(/-+$/,"")},this._cleanSSIDBlur=e=>{const o=e.target;o.value=o.value.trim()}}render(){let e,o,t=!1;return"ask_esphome_web"===this._state?[e,o,t]=this._renderAskESPHomeWeb():"basic_config"===this._state?[e,o,t]=this._renderBasicConfig():"pick_board"===this._state?(e="Select your ESP device",o=this._renderPickBoard()):"connect_webserial"===this._state?(e="Installation",o=this._renderConnectSerial()):"connecting_webserial"===this._state?(o=this._renderProgress("Connecting"),t=!0):"prepare_flash"===this._state?(o=this._renderProgress("Preparing installation"),t=!0):"flashing"===this._state?(o=void 0===this._writeProgress?this._renderProgress("Erasing"):this._renderProgress(u`
                Installing<br /><br />
                This will take
    ...
    `}_renderAskESPHomeWeb(){return["New device",u`
      ...
      <div>
        ${$?"Your browser does not support WebSerial.":"You are not browsing the dashboard over a secure connection (HTTPS)."}
      ...
      ></mwc-button>
    `,!1]}_renderBasicConfig(){if(void 0===this._hasWifiSecrets)return[void 0,this._renderProgress("Initializing"),!0];return[O?"New device":"Create configuration",u`
    ...
    `}_renderDone(){return this._error?this._renderMessage("👀",this._error,!0):u`
      ...
      ${this._installed?"":u`
            ...
            ></mwc-button>
          `}
    `}firstUpdated(e){super.firstUpdated(e),C().then((e=>{this._hasWifiSecrets=e}))}updated(e){if(super.updated(e),e.has("_state")||e.has("_hasWifiSecrets")){const e=this.shadowRoot.querySelector("mwc-textfield, mwc-radio, mwc-button");e&&e.updateComplete.then((()=>e.focus()))}e.has("_board")&&"CUSTOM"===this._board&&(this._customBoard=this.shadowRoot.querySelector("select").value)}async _handleBasicConfigSubmit(){const e=this._inputName,o=e.reportValidity(),t=!!this._hasWifiSecrets||this._inputSSID.reportValidity();if(!o||!t)return void(o?this._inputSSID.focus():e.focus());const i=e.value;try{return await R(`${i}.yaml`),void(this._error="Name already in use")}catch(e){}this._data.name=i,this._hasWifiSecrets||(this._wifi={ssid:this._inputSSID.value,password:this._inputPassword.value}),setTimeout((()=>{this._state=O&&$?"connect_webserial":"pick_board"}),0)}_handlePickBoardRadio(e){this._board=e.target.value}_handlePickBoardCustom(e){this._customBoard=e.target.value}async _handlePickBoardSubmit(){"ESP32"===this._board?(this._data.platform="ESP32",this._data.board="esp32dev"):"ESP8266"===this._board?(this._data.platform="ESP8266",this._data.board="esp01_1m"):this._data.board=this._customBoard,this._busy=!0;try{this._wifi&&await T(this._wifi.ssid,this._wifi.password),await A(this._data),k(),this._state="done"}catch(e){this._error=e.message||e}finally{this._busy=!1}}_handleConnectSerialSkip(){this._error=void 0,this._state="pick_board"}async _handleConnectSerialSubmit(){let e;this._busy=!0,this._error=void 0;let o=!1;try{try{e=await I(console)}catch(e){return console.error(e),void("NotFoundError"!==e.name&&(this._error=e.message||String(e)))}this._state="connecting_webserial";try{await e.initialize()}catch(o){return console.error(o),this._state="connect_webserial",void(e.connected&&(this._error="Failed to initialize. Try resetting your device or holding the BOOT button while selecting your serial port until it starts preparing the installation."))}if(this._state="prepare_flash",e.chipFamily===D)this._board="ESP32",this._data.board="esp32dev";else{if(e.chipFamily!==B)return this._state="connect_webserial",void(this._error=`Unable to identify the connected device (${e.chipFamily}).`);this._board="ESP8266",this._data.board="esp01_1m"}try{await A(this._data)}catch(e){return console.error(e),this._state="connect_webserial",void(this._error="Unable to create the configuration")}o=!0;try{await L(this._configFilename)}catch(e){return console.error(e),this._state="connect_webserial",void(this._error="Unable to compile the configuration")}this._state="flashing";try{const o=await H(this._configFilename);await W(e,o,!0,(e=>{this._writeProgress=e}))}catch(e){return console.error(e),this._state="connect_webserial",void(this._error="Error installing the configuration")}o=!1,this._installed=!0,await e.hardReset(),this._state="wait_come_online";try{await new Promise(((e,o)=>{const t=S((o=>{o[this._configFilename]&&(t(),clearTimeout(i),e(void 0))})),i=setTimeout((()=>{t(),o("Timeout")}),2e4)}))}catch(e){console.error(e),this._error="Configuration created but unable to detect the device on the network"}this._state="done"}finally{this._busy=!1,e&&(e.connected&&(console.log("Disconnecting esp"),await e.disconnect()),console.log("Closing port"),await e.port.close()),o&&await M(this._configFilename)}}get _configFilename(){return`${this._data.name}.yaml`}async _handleClose(){this.parentNode.removeChild(this)}};te.styles=_`
    :host {
  ...
  `,i([a()],te.prototype,"_busy",void 0),i([a()],te.prototype,"_board",void 0),i([a()],te.prototype,"_hasWifiSecrets",void 0),i([a()],te.prototype,"_writeProgress",void 0),i([a()],te.prototype,"_state",void 0),i([a()],te.prototype,"_error",void 0),i([r("mwc-textfield[name=name]")],te.prototype,"_inputName",void 0),i([r("mwc-textfield[name=ssid]")],te.prototype,"_inputSSID",void 0),i([r("mwc-textfield[name=password]")],te.prototype,"_inputPassword",void 0),te=i([v("esphome-wizard-dialog")],te);export{te as ESPHomeWizardDialog};
