import{a as t,r as o,_ as e,c as s,f as i,n as r,s as a,$ as n}from"./index-7c1fc97a.js";import"./c.c146edc1.js";import"./c.da084acf.js";import{g as c}from"./c.1aae5b08.js";import{m as l,s as p,a as m}from"./c.c5564c7b.js";const h=(t,o)=>{import("./c.3b7e951b.js");const e=document.createElement("esphome-logs-dialog");e.configuration=t,e.target=o,document.body.append(e)},d=(t,o,e)=>{import("./c.c350f817.js");const s=document.createElement("esphome-logs-webserial-dialog");s.configuration=e,s.port=t,s.closePortOnClose=o,document.body.append(s)};let w=class extends a{constructor(){super(...arguments),this._show="options"}render(){let t,o;return"options"===this._show?(t="How to get the logs for your device?",o=n`
        <mwc-list-item
          twoline
          hasMeta
          dialogAction="close"
