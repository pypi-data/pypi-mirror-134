import{e as t,d as e,t as o,b as i,r as s,_ as r,a as n,c as a,n as l,s as c,$ as d}from"./index-5e3d0838.js";import{g as p}from"./c.6a7f81e8.js";import"./c.5bab727a.js";import{E as h,c as m}from"./c.fecaa79b.js";import{m as u,s as _,a as w}from"./c.92b39d00.js";import{c as g,g as v}from"./c.1e7f773d.js";class b{constructor(t){this.U=t}disconnect(){this.U=void 0}reconnect(t){this.U=t}deref(){return this.U}}class f{constructor(){this.Y=void 0,this.q=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.q=t)))}resume(){var t;null===(t=this.q)||void 0===t||t.call(this),this.Y=this.q=void 0}}const $=t=>!o(t)&&"function"==typeof t.then;const y=t(class extends e{constructor(){super(...arguments),this._$Cft=1073741823,this._$Cwt=[],this._$CG=new b(this),this._$CK=new f}render(...t){var e;return null!==(e=t.find((t=>!$(t))))&&void 0!==e?e:i}update(t,e){const o=this._$Cwt;let s=o.length;this._$Cwt=e;const r=this._$CG,n=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$Cft);t++){const i=e[t];if(!$(i))return this._$Cft=t,i;t<s&&i===o[t]||(this._$Cft=1073741823,s=0,Promise.resolve(i).then((async t=>{for(;n.get();)await n.get();const e=r.deref();if(void 0!==e){const o=e._$Cwt.indexOf(i);o>-1&&o<e._$Cft&&(e._$Cft=o,e.setValue(t))}})))}return i}disconnected(){this._$CG.disconnect(),this._$CK.pause()}reconnected(){this._$CG.reconnect(this),this._$CK.resume()}}),C=(t,e)=>{import("./c.38631be2.js");const o=document.createElement("esphome-install-server-dialog");o.configuration=t,o.target=e,document.body.append(o)},S=(t,e)=>{import("./c.393b0151.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.downloadFactoryFirmware=e,document.body.append(o)},P=async t=>{import("./c.71f60c77.js");const e=document.createElement("esphome-no-port-picked-dialog");return e.doTryAgain=t,document.body.append(e),!0},k=async(t,e)=>{let o;if(import("./c.d4b137bd.js"),t.port)o=new h(t.port,console);else try{o=await m(console)}catch(o){return void("NotFoundError"===o.name?P((()=>k(t,e))):alert(`Unable to connect: ${o.message}`))}e&&e();const i=document.createElement("esphome-install-web-dialog");i.params=t,i.esploader=o,document.body.append(i)};let x=class extends c{constructor(){super(...arguments),this._state="pick_option"}render(){let t,e;return"pick_option"===this._state?(t="How do you want to install this on your ESP device?",e=d`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
    ...
    `}firstUpdated(t){super.firstUpdated(t),this._updateSerialPorts()}async _updateSerialPorts(){this._ports=await p()}willUpdate(t){super.willUpdate(t),t.has("_state")&&"web_instructions"===this._state&&!this._compileConfiguration&&(this._abortCompilation=new AbortController,this._compileConfiguration=g(this.configuration).then((()=>d`
          ...
          `)).finally((()=>{this._abortCompilation=void 0})))}updated(t){if(super.updated(t),t.has("_state"))if("pick_server_port"===this._state){const t=async()=>{await this._updateSerialPorts(),this._updateSerialInterval=window.setTimeout((async()=>{await t()}),5e3)};t()}else"pick_server_port"===t.get("_state")&&(clearTimeout(this._updateSerialInterval),this._updateSerialInterval=void 0)}_storeDialogWidth(){this.style.setProperty("--mdc-dialog-min-width",`${this.shadowRoot.querySelector("mwc-list-item").clientWidth+4}px`)}_showServerPorts(){this._storeDialogWidth(),this._state="pick_server_port"}_handleManualDownload(){S(this.configuration,!1)}_handleWebDownload(){S(this.configuration,!0)}_handleLegacyOption(t){C(this.configuration,t.currentTarget.port),this._close()}_handleBrowserInstall(){if(!_||!w)return this._storeDialogWidth(),void(this._state="web_instructions");k({configuration:this.configuration},(()=>this._close()))}_close(){this.shadowRoot.querySelector("mwc-dialog").close()}async _handleClose(){var t;null===(t=this._abortCompilation)||void 0===t||t.abort(),this._updateSerialInterval&&(clearTimeout(this._updateSerialInterval),this._updateSerialInterval=void 0),this.parentNode.removeChild(this)}};x.styles=s`
    a {
  ...
  `,r([n()],x.prototype,"configuration",void 0),r([a()],x.prototype,"_ports",void 0),r([a()],x.prototype,"_state",void 0),r([a()],x.prototype,"_error",void 0),x=r([l("esphome-install-choose-dialog")],x);var j=Object.freeze({__proto__:null});export{S as a,k as b,j as i,C as o};
