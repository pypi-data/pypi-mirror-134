...
class WebNormal(WebNormal):
    ...
    def _build_instance(plain: dict) -> WebNormal:
        ...
        __returns.titleHighlighted = plain.get("title_highlighted")
        __returns.desHighlighted = plain.get("desc_highlighted")
        return __returns
