...
class WebSubParser(BaseSpider):
    ...
    def parse_news_block(self, news: BeautifulSoup) -> Dict:
        ...
        try:
            ...
            for row in news_rows:
                ...
                row_title_highlighted = self._get_highlighted(row_title)
                news_detail.append(
                    {
                        "title": row_title,
                        "time": row_time,
                        "author": row_author,
                        "url": row_url,
                        "title_highlighted": row_title_highlighted,
                        "des": None,
                    }
                )
    ...
    def parse_video_block(self, video: BeautifulSoup) -> Dict:
        ...
        if video:
            ...
            for row in video_rows:
                row_res = []
                videos = row.findAll("div", class_="c-span4")
                for v in videos:
                    v_link = v.find("a")
                    ...
                    v_title_highlighted = self._get_highlighted(v_title)
                    row_res.append(
                        {
                            "title": v_title,
                            "url": v_url,
                            ...
                            "length": v_len,
                            "origin": v_from,
                            "title_highlighted": v_title_highlighted,
                        }
                    )
        ...
        if baike:
            ...
            try:
                ...
                try:
                    ...
                    b_cover = None
                    b_cover_type = None
            b_title_highlighted = self._get_highlighted(baike.find("h3"))
            b_des_highlighted = self._get_highlighted(
                baike.find("div", class_="c-span-last").find(
                    "div", class_="c-font-normal"
                )
            )
            baike = {
                "title": b_title,
                ...
                "title_highlighted": b_title_highlighted,
                "des_highlighted": b_des_highlighted,
            }
        return baike
    ...
    def parse_tieba_block(self, tieba: BeautifulSoup) -> Dict:
        ...
        if tieba:
            ...
            try:
                ...
                t_cover = None
            t_title_highlighted = self._get_highlighted(tieba.find("h3"))
            ...
            for hot in t_hot_:
                ...
                t_h_title_highlighted = self._get_highlighted(t_h_title)
                t_hot.append(
                    {
                        "title": t_h_title,
                        "url": t_h_url,
                        "clicks": t_h_clicks,
                        "replies": t_h_replies,
                        "title_highlighted": t_h_title_highlighted,
                    }
                )
            tieba = {
                "title": t_title,
                ...
                "cover": t_cover,
                "hot": t_hot,
                "title_highlighted": t_title_highlighted,
            }
        return tieba
    ...
    def parse_blog_block(self, blog: BeautifulSoup) -> Dict:
        ...
        if blog is not None:
            ...
            b_title_highlighted = self._get_highlighted(b_title)
            ...
            for b in b_blogs_:
                ...
                b_blog_des = None
                b_blog_des_highlighted = []
                for p in b_blog_parent:
                    if p["class"][0].startswith("blog-summary"):
                        b_blog_des = p.text
                        b_blog_des_highlighted = self._get_highlighted(p)
                        break
                b_blog_title_highlighted = self._get_highlighted(
                    b_current_blog_header.find("a")
                )
                b_blogs.append(
                    {
                        "title": b_blog_title,
                        ...
                        "tags": b_blog_tags,
                        "des": b_blog_des,
                        "title_highlighted": b_blog_title_highlighted,
                        "des_highlighted": b_blog_des_highlighted,
                    }
                )
    ...
    def parse_gitee_block(self, gitee: BeautifulSoup) -> Dict:
        ...
        if gitee is not None:
            ...
            g_title_highlighted = self._get_highlighted(g_title)
            g_des_highlighted = self._get_highlighted(g_des)
            gitee = {
                "title": g_title,
                "url": g_url,
                "des": g_des,
                ...
                "watch": g_watch,
                "status": g_status,
                "title_highlighted": g_title_highlighted,
                "des_highlighted": g_des_highlighted,
            }
        return gitee
