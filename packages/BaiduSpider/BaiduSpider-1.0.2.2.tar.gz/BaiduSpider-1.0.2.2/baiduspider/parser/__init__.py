...
class Parser(BaseSpider):
    ...
    def parse_web(self, content: str, exclude: list) -> dict:
        ...
        for result in results:
            ...
            # 高亮关键词
            title_highlighted = self._get_highlighted(title)
            des_highlighted = self._get_highlighted(des)
            # 加入结果
                ...
                res.append(
                    {
                        ...
                        "des_highlighted": des_highlighted,
                        "type": "result",
                    }
                )
        soup = BeautifulSoup(content, "html.parser")
    ...
    def parse_baike(self, content: str) -> dict:
        ...
        for res in container:
            ...
            url = (
                ...
                if not url_pre.startswith("https://baike.baidu.com")
                else ""
            ) + url_pre
            # 标题
