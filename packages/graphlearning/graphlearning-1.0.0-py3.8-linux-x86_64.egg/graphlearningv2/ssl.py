...
import torch, sys, os, datetime, matplotlib
...
class multiclass_mbo(ssl):
    def __init__(self, W, class_priors=None, Ns=6, T=10, dt=0.15, mu=50, num_eig=300):
        """Multiclass MBO
        ===================
...
class amle(ssl):
    def __init__(self, W, class_priors=None, tol=1e-3, max_num_it=1e5, weighted=True, prog=False):
        """AMLE learning
        ===================
