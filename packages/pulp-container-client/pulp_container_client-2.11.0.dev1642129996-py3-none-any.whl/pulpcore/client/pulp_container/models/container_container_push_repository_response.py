...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, name=None, latest_version_href=None, description=None, versions_href=None, pulp_labels=None, retain_repo_versions=None, pulp_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
