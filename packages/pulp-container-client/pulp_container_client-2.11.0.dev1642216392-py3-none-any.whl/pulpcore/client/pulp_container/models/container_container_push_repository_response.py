...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, retain_repo_versions=None, name=None, pulp_href=None, latest_version_href=None, pulp_created=None, versions_href=None, description=None, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
