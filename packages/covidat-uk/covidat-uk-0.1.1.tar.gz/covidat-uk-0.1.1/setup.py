...
setup(
    name='covidat-uk',         # How you named your package folder (MyLib)
    packages=['covidat-uk'],   # Chose the same as "name"
    ...
    download_url='https://github.com/Mlograda/covidat-uk/archive/refs/tags/v0.1.1.tar.gz',
