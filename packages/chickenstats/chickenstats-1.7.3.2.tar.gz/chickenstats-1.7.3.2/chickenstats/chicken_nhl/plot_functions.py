...
def game_rink_map(data, good_team = None, title = None, strengths = ['all', '5v5', 'PP', 'SH', 'EV', '3v3'],
    ...
    for strength in strengths:
        ...
        for team in teams:
            ...
            zorder_dict = {'GOAL': 3, 'SHOT': 2, 'MISS': 1}
            ...
            for result, color in colors_dict.items():
                ...
                rink.scatter(event_df.norm_coords_x, event_df.norm_coords_y, c = color, label = result, s = 250, alpha = 0.8,
            ...
            if team == good_team:
                ...
                ax.legend(loc="lower center", ncol=3, title = f'{team}', fontsize = 14,
                            title_fontsize = 16, facecolor = 'white', framealpha = 1, edgecolor = 'gray').set_zorder(-1)
            if team == bad_team:
