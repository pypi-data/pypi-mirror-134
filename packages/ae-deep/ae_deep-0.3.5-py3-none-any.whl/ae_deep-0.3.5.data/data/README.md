...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/ae-group/ae_deep/release0.2.5?logo=python)](
    https://gitlab.com/ae-group/ae_deep/-/tree/release0.2.5)
[![PyPIVersions](https://img.shields.io/pypi/v/ae_deep)](
    https://pypi.org/project/ae-deep/#history)

>ae namespace module portion deep: deep data structure search and replace.
...
[ReadTheDocs](
https://ae.readthedocs.io/en/latest/_autosummary/ae.deep.html#module-ae.deep
