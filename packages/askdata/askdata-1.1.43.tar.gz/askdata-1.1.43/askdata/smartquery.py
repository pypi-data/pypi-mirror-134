        ...
        consistent_datatypes = {"numeric":
                                ...
                                "string":
                                    ["string", "varchar", "varchar2", "char",
                                     ...
                                     "ntext", "tinytext", "mediumtext", "longtext",
        ...
        for where_condition in where:
            if isinstance(where_condition, Condition):
                ...
                if (
                    ...
                    if where_condition.field.aggregation is not None and isinstance(
                            where_condition.field.aggregation, str):
                        formatted_cond = where_condition.field.aggregation + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ") " + operator + " " + formatted_value
                    elif where_condition.field.aggregation is not None and isinstance(
                            where_condition.field.aggregation, SQLFunction):
                        formatted_cond = where_condition.field.aggregation.name + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ") " + operator + " " + formatted_value
                    else:
                    ...
                    if where_condition.field.sourceFormat is not None:
                        if where_condition.field.aggregation is not None and isinstance(
                                where_condition.field.aggregation, str):
                            formatted_cond = where_condition.field.aggregation + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ", format " + where_condition.field.sourceFormat + ") " + operator + " " + formatted_value
                        elif where_condition.field.aggregation is not None and isinstance(
                                where_condition.field.aggregation, SQLFunction):
                            formatted_cond = where_condition.field.aggregation.name + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ", format " + where_condition.field.sourceFormat + ") " + operator + " " + formatted_value
                        else:
                        ...
                        if where_condition.field.aggregation is not None and isinstance(
                                where_condition.field.aggregation, str):
                            formatted_cond = where_condition.field.aggregation + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ", format YYYY-MM-DD" + ") " + operator + " " + formatted_value
                        elif where_condition.field.aggregation is not None and isinstance(
                                where_condition.field.aggregation, SQLFunction):
                            formatted_cond = where_condition.field.aggregation.name + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ", to " + where_condition.field.internalDataType + ", format YYYY-MM-DD" + ") " + operator + " " + formatted_value
                        else:
                    ...
                    if where_condition.field.aggregation is not None and isinstance(
                            where_condition.field.aggregation, str):
                        formatted_cond = where_condition.field.aggregation + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ") " + operator + " " + formatted_value
                    elif where_condition.field.aggregation is not None and isinstance(
                            where_condition.field.aggregation,
                            SQLFunction):
                        formatted_cond = where_condition.field.aggregation.name + " " + where_condition.field.column + " (" + where_condition.field.sourceDataType + ") " + operator + " " + formatted_value
                    else:
