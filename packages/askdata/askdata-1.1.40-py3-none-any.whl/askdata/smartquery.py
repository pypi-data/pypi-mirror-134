...
class Query:
    ...
    def _where_spell_out(self, where):
        ...
        for where_condition in where:
            if isinstance(where_condition, Condition):
                ...
                elif where_condition.field.sourceDataType is not None:
    ...
    def spell_out(self):
        ...
        consistent_datatypes = {"numeric": ["int", "float", "double", "int32", "int64"],
                                "date": ["date", "timestamp", "datetime"],
                                "string": ["string", "varchar", "varchar2"]}
        ...
        for field in self.fields:
            ...
            if field.sqlExpression is not None:
                ...
                if (field.internalDataType.lower() == "numeric" or field.internalDataType.lower() == "string") and field.sourceDataType.lower() not in consistent_vec:
