...
class CfnUserPool(
    ...
    def __init__(
        ...
        *,
        ...
        :param lambda_config: The Lambda trigger configuration information for the new user pool. .. epigraph:: In a push model, event sources (such as Amazon S3 and custom applications) need permission to invoke a function. So you will need to make an extra call to add permission for these event sources to invoke your Lambda function. For more information on using the Lambda API to add permission, see `AddPermission <https://docs.aws.amazon.com/lambda/latest/dg/API_AddPermission.html>`_ . For adding permission using the AWS CLI , see `add-permission <https://docs.aws.amazon.com/cli/latest/reference/lambda/add-permission.html>`_ .
        :param mfa_configuration: The multi-factor (MFA) configuration. Valid values include:. - ``OFF`` MFA will not be used for any users. - ``ON`` MFA is required for all users to sign in. - ``OPTIONAL`` MFA will be required only for individual users who have an MFA factor enabled.
        ...
        :param user_pool_add_ons: Used to enable advanced security risk detection. Set the key ``AdvancedSecurityMode`` to the value "AUDIT".
    ...
    class AdminCreateUserConfigProperty:
        def __init__(
            ...
            *,
            ...
            :param unused_account_validity_days: The user account expiration limit, in days, after which the account is no longer usable. To reset the account after that time limit, you must call ``AdminCreateUser`` again, specifying ``"RESEND"`` for the ``MessageAction`` parameter. The default value for this parameter is 7. .. epigraph:: If you set a value for ``TemporaryPasswordValidityDays`` in ``PasswordPolicy`` , that value will be used and ``UnusedAccountValidityDays`` will be deprecated for that user pool.
    ...
    class DeviceConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param challenge_required_on_new_device: Indicates whether a challenge is required on a new device. Only applicable to a new device.
            :param device_only_remembered_on_user_prompt: If true, a device is only remembered on user prompt.
    ...
    class EmailConfigurationProperty:
        ...
        def email_sending_account(self) -> typing.Optional[builtins.str]:
            ...
            To look up the email delivery limit for the default option, see `Limits in Amazon Cognito <https://docs.aws.amazon.com/cognito/latest/developerguide/limits.html>`_ in the *Amazon Cognito Developer Guide* .
    ...
    class PasswordPolicyProperty:
        def __init__(
            ...
            *,
            ...
            :param minimum_length: The minimum length of the password policy that you have set. Cannot be less than 6.
            ...
            :param temporary_password_validity_days: In the password policy you have set, refers to the number of days a temporary password is valid. If the user does not sign-in during this time, their password will need to be reset by an administrator. .. epigraph:: When you set ``TemporaryPasswordValidityDays`` for a user pool, you will no longer be able to set the deprecated ``UnusedAccountValidityDays`` value for that user pool.
    ...
    class SmsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param sns_caller_arn: The Amazon Resource Name (ARN) of the Amazon Simple Notification Service (SNS) caller. This is the ARN of the IAM role in your AWS account which Cognito will use to send SMS messages. SMS messages are subject to a `spending limit <https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-email-phone-verification.html>`_ .
        ...
        def sns_caller_arn(self) -> typing.Optional[builtins.str]:
            ...
            This is the ARN of the IAM role in your AWS account which Cognito will use to send SMS messages. SMS messages are subject to a `spending limit <https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-settings-email-phone-verification.html>`_ .
...
class CfnUserPoolClient(
    ...
    def __init__(
        ...
        *,
        ...
        :param allowed_o_auth_flows_user_pool_client: Set to true if the client is allowed to follow the OAuth protocol when interacting with Cognito user pools.
        ...
        :param analytics_configuration: The Amazon Pinpoint analytics configuration for collecting metrics for this user pool. .. epigraph:: In regions where Pinpoint is not available, Cognito User Pools only supports sending events to Amazon Pinpoint projects in us-east-1. In regions where Pinpoint is available, Cognito User Pools will support sending events to Amazon Pinpoint projects within that same region.
        ...
        :param refresh_token_validity: The time limit, in days, after which the refresh token is no longer valid and cannot be used.
    ...
    def enable_token_revocation(
        ...
        '''Enables or disables token revocation. For more information about revoking tokens, see `RevokeToken <https://docs.aws.amazon.com/cognito-user-identity-pools/latest/APIReference/API_RevokeToken.html>`_ .
    ...
    class AnalyticsConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            :param role_arn: The ARN of an IAM role that authorizes Amazon Cognito to publish events to Amazon Pinpoint analytics.
...
class CfnUserPoolGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param role_arn: The role ARN for the group.
        '''
...
class CfnUserPoolRiskConfigurationAttachment(
    ...
    def __init__(
        ...
        *,
        ...
        :param user_pool_id: The user pool ID.
        :param account_takeover_risk_configuration: The account takeover risk configuration object including the ``NotifyConfiguration`` object and ``Actions`` to take in the case of an account takeover.
    ...
    class AccountTakeoverActionTypeProperty:
        def __init__(
            ...
            *,
            ...
            :param event_action: The event action. - ``BLOCK`` Choosing this action will block the request. - ``MFA_IF_CONFIGURED`` Throw MFA challenge if user has configured it, else allow the request. - ``MFA_REQUIRED`` Throw MFA challenge if user has configured it, else block the request. - ``NO_ACTION`` Allow the user sign-in.
    ...
    class NotifyConfigurationTypeProperty:
        def __init__(
            ...
            *,
            ...
            :param source_arn: The Amazon Resource Name (ARN) of the identity that is associated with the sending authorization policy. It permits Amazon Cognito to send for the email address specified in the ``From`` parameter.
            :param block_email: Email template used when a detected risk event is blocked.
            :param from_: The email address that is sending the email. It must be either individually verified with Amazon SES, or from a domain that has been verified with Amazon SES.
            :param mfa_email: The MFA email template used when MFA is challenged as part of a detected risk.
    ...
    class RiskExceptionConfigurationTypeProperty:
        def __init__(
            ...
            *,
            ...
            :param blocked_ip_range_list: Overrides the risk decision to always block the pre-authentication requests. The IP range is in CIDR notation: a compact representation of an IP address and its associated routing prefix.
            :param skipped_ip_range_list: Risk detection is not performed on the IP addresses in the range list. The IP range is in CIDR notation.
...
class CfnUserPoolUser(
    ...
    def __init__(
        ...
        *,
        ...
        :param desired_delivery_mediums: Specify ``"EMAIL"`` if email will be used to send the welcome message. Specify ``"SMS"`` if the phone number will be used. The default value is ``"SMS"`` . More than one value can be specified.
        :param force_alias_creation: This parameter is only used if the ``phone_number_verified`` or ``email_verified`` attribute is set to ``True`` . Otherwise, it is ignored. If this parameter is set to ``True`` and the phone number or email address specified in the UserAttributes parameter already exists as an alias with a different user, the API call will migrate the alias from the previous user to the newly created user. The previous user will no longer be able to log in using that alias. If this parameter is set to ``False`` , the API throws an ``AliasExistsException`` error if the alias already exists. The default value is ``False`` .
        :param message_action: Set to ``"RESEND"`` to resend the invitation message to a user that already exists and reset the expiration limit on the user's account. Set to ``"SUPPRESS"`` to suppress sending the message. Only one value can be specified.
