...
from postbook.CustomTemplateExporter import CustomTemplateExporter

class CustomHTMLExporter(CustomTemplateExporter):
    """
    ...
    def _init_resources(self, resources):
        ...
        def resources_include_js(name):
            print("environtment is ",self.environment)
            env = self.environment
