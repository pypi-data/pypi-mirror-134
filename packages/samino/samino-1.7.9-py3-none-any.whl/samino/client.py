...
class Client:
    ...
    def send_message(self, chatId: str, message: str = None, messageType: int = 0, replyTo: str = None, stickerId: str = None, mentionUserIds: list = None, snippetLink: str = None, snippetImage: BinaryIO = None, embedId: str = None, embedType: int = None, embedLink: str = None, embedTitle: str = None, embedContent: str = None, embedImage: BinaryIO = None, file: BinaryIO = None, fileType: str = None):
