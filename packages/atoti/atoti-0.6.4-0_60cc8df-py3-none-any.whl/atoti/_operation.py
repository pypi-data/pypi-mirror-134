...
@dataclass(frozen=True, eq=False)  # pylint: disable=keyword-only-dataclass
...
@dataclass(eq=False, frozen=True)  # type: ignore[misc] # pylint: disable=keyword-only-dataclass
