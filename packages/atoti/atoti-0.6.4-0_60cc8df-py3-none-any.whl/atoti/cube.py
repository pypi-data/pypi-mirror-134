...
from atoti_core import (
    ...
    running_in_ipython as _running_in_ipython,
)
from typeguard import typechecked, typeguard_ignore

from ._functions.measure import value as value_function
...
class Cube(LocalCube[Hierarchies, Levels, Measures]):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            java_api=java_api,
            session=session,
            hierarchies=Hierarchies(_java_api=java_api, _cube=self),
    ...
    def _aggregate_providers(self) -> Sequence[PartialAggregateProvider]:
        ...
        return self._java_api.get_aggregate_providers(
            self.name,
            get_level_from_identifier=self._get_level_from_identifier,
        )
