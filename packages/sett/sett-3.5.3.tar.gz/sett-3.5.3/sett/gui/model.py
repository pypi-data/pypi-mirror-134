...
from .ui_model_bind import ClassWithListener
from ..core import gpg
from ..core.metadata import Purpose
from ..utils.config import Config
from ..protocols import Protocol, sftp, liquid_files
...
class TableModel(QtCore.QAbstractTableModel):
    ...
    def data(
        self, index: QtCore.QModelIndex, role: int = default_display_role
    ) -> Optional[Any]:
    ...
    def removeRows(
        self, row: int, count: int, _parent: QtCore.QModelIndex = QtCore.QModelIndex()
    ) -> bool:
