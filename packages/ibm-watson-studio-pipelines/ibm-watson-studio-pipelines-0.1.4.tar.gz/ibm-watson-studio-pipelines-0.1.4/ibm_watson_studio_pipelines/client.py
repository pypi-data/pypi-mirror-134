...
from ibm_cloud_sdk_core.authenticators import Authenticator, IAMAuthenticator, CloudPakForDataAuthenticator
import ibm_boto3
...
from .client_errors import JsonParsingError, MissingValueError, \
    ...
    PublicCloudOnlyError, FilesResultsNotSupportedError
...
class WSPipelines(BaseService):
    ...
    def __init__(
        ...
        *,
        ...
        authenticator, is_public = self._get_authenticator(apikey, url)
    ...
    def _get_authenticator(self, apikey: str, url: str) -> Tuple[Authenticator, bool]:
