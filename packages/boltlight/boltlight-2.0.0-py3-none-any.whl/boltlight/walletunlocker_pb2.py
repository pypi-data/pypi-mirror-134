...
# source: boltlight/walletunlocker.proto
...
_INITWALLETREQUEST.fields_by_name['channel_backups'].message_type = boltlight_dot_rpc__pb2._CHANBACKUPSNAPSHOT
_UNLOCKWALLETREQUEST.fields_by_name['channel_backups'].message_type = boltlight_dot_rpc__pb2._CHANBACKUPSNAPSHOT
...
GenSeedRequest = _reflection.GeneratedProtocolMessageType('GenSeedRequest', (_message.Message,), {
  ...
  '__module__' : 'boltlight.walletunlocker_pb2'
