...
#include <../../build/temp.macosx-10.14-x86_64-3.9/dlstatic/revlib/include/rev/SparkMaxPIDController.h>
...
using ArbFFUnits = rev::SparkMaxPIDController::ArbFFUnits;
    ...
    REVLibError SetP(double gain, int slotID) override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(REVLibError), LookupBase,
            "setP", gain, slotID);
        return CxxCallBase::SetP(gain, slotID);
    }
#endif
    ...
    REVLibError SetI(double gain, int slotID) override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(REVLibError), LookupBase,
            "setI", gain, slotID);
        return CxxCallBase::SetI(gain, slotID);
    }
#endif
    ...
    REVLibError SetD(double gain, int slotID) override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(REVLibError), LookupBase,
            "setD", gain, slotID);
        return CxxCallBase::SetD(gain, slotID);
    }
#endif
    ...
    REVLibError SetDFilter(double gain, int slotID) override {
        ...
        return CxxCallBase::SetDFilter(gain, slotID);
    }
#endif
    ...
    REVLibError SetFF(double gain, int slotID) override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(REVLibError), LookupBase,
            "setFF", gain, slotID);
        return CxxCallBase::SetFF(gain, slotID);
    }
#endif
    ...
    REVLibError SetIZone(double IZone, int slotID) override {
        ...
        return CxxCallBase::SetIZone(IZone, slotID);
    }
#endif
    ...
    REVLibError SetOutputRange(double min, double max, int slotID) override {
        ...
        return CxxCallBase::SetOutputRange(min, max, slotID);
    }
#endif
    ...
    double GetP(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getP", slotID);
        return CxxCallBase::GetP(slotID);
    }
#endif
    ...
    double GetI(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getI", slotID);
        return CxxCallBase::GetI(slotID);
    }
#endif
    ...
    double GetD(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getD", slotID);
        return CxxCallBase::GetD(slotID);
    }
#endif
    ...
    double GetDFilter(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getDFilter", slotID);
        return CxxCallBase::GetDFilter(slotID);
    }
#endif
    ...
    double GetFF(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getFF", slotID);
        return CxxCallBase::GetFF(slotID);
    }
#endif
    ...
    double GetIZone(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getIZone", slotID);
        return CxxCallBase::GetIZone(slotID);
    }
#endif
    ...
    double GetOutputMin(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getOutputMin", slotID);
        return CxxCallBase::GetOutputMin(slotID);
    }
#endif
    ...
    double GetOutputMax(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getOutputMax", slotID);
        return CxxCallBase::GetOutputMax(slotID);
    }
#endif
    ...
    REVLibError SetSmartMotionMaxVelocity(double maxVel, int slotID) override {
        ...
        return CxxCallBase::SetSmartMotionMaxVelocity(maxVel, slotID);
    }
#endif
    ...
    REVLibError SetSmartMotionMaxAccel(double maxAccel, int slotID) override {
        ...
        return CxxCallBase::SetSmartMotionMaxAccel(maxAccel, slotID);
    }
#endif
    ...
    REVLibError SetSmartMotionMinOutputVelocity(double minVel, int slotID) override {
        ...
        return CxxCallBase::SetSmartMotionMinOutputVelocity(minVel, slotID);
    }
#endif
    ...
    REVLibError SetSmartMotionAllowedClosedLoopError(double allowedErr, int slotID) override {
        ...
        return CxxCallBase::SetSmartMotionAllowedClosedLoopError(allowedErr, slotID);
    }
#endif
    ...
    double GetSmartMotionMaxVelocity(int slotID) const override {
        ...
        return CxxCallBase::GetSmartMotionMaxVelocity(slotID);
    }
#endif
    ...
    double GetSmartMotionMaxAccel(int slotID) const override {
        ...
        return CxxCallBase::GetSmartMotionMaxAccel(slotID);
    }
#endif
    ...
    double GetSmartMotionMinOutputVelocity(int slotID) const override {
        ...
        return CxxCallBase::GetSmartMotionMinOutputVelocity(slotID);
    }
#endif
    ...
    double GetSmartMotionAllowedClosedLoopError(int slotID) const override {
        ...
        return CxxCallBase::GetSmartMotionAllowedClosedLoopError(slotID);
    }
#endif
    ...
    REVLibError SetIMaxAccum(double iMaxAccum, int slotID) override {
        ...
        return CxxCallBase::SetIMaxAccum(iMaxAccum, slotID);
    }
#endif
    ...
    double GetIMaxAccum(int slotID) const override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(double), LookupBase,
            "getIMaxAccum", slotID);
        return CxxCallBase::GetIMaxAccum(slotID);
    }
#endif
    ...
    REVLibError SetIAccum(double iAccum) override {
        ...
        PYBIND11_OVERRIDE_IMPL(PYBIND11_TYPE(REVLibError), LookupBase,
            "setIAccum", iAccum);
        return CxxCallBase::SetIAccum(iAccum);
    }
#endif
    ...
    REVLibError SetFeedbackDevice(const CANSensor& sensor) override {
        ...
        return CxxCallBase::SetFeedbackDevice(sensor);
    }
#endif
