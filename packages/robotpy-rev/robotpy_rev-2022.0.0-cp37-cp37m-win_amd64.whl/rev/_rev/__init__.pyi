...
class CANSensor():
    ...
    def setInverted(self, inverted: bool) -> REVLibError: 
        ...
        """
    pass
class CANSparkMaxLowLevel(wpilib.interfaces._interfaces.MotorController, wpilib.interfaces._interfaces.SpeedController):
    class ControlType():
        """
        Members:
    ...
    def setPeriodicFramePeriod(self, frame: CANSparkMaxLowLevel.PeriodicFrame, periodMs: int) -> REVLibError: 
        ...
        """
    kAPIBuildVersion = 1
    kAPIMajorVersion = 230
    kAPIMinorVersion = 1
    kAPIVersion = 132514049
    pass
class CANSparkMax(CANSparkMaxLowLevel, wpilib.interfaces._interfaces.MotorController, wpilib.interfaces._interfaces.SpeedController):
