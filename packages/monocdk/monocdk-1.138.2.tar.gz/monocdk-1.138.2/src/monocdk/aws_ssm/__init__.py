...
class CfnMaintenanceWindowTask(
    ...
    def __init__(
        ...
        *,
        ...
        :param max_concurrency: The maximum number of targets this task can be run for, in parallel.
        :param max_errors: The maximum number of errors allowed before this task stops being scheduled.
