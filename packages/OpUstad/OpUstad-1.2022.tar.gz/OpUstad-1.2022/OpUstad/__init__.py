...
if BOT_TOKEN11:
 UstaD11 = TelegramClient('UstaD11', APP_ID, API_HASH).start(bot_token=BOT_TOKEN11) 
else:
    UstaD11=None

if BOT_TOKEN12:
    UstaD12 = TelegramClient('UstaD12', APP_ID, API_HASH).start(bot_token=BOT_TOKEN12) 
else:
    UstaD12=None

if BOT_TOKEN13:
 UstaD13 = TelegramClient('UstaD13', APP_ID, API_HASH).start(bot_token=BOT_TOKEN13) 
else:
    UstaD13=None

if BOT_TOKEN14:
 UstaD14 = TelegramClient('UstaD14', APP_ID, API_HASH).start(bot_token=BOT_TOKEN14) 
else:
    UstaD14=None

if BOT_TOKEN15:
    UstaD15 = TelegramClient('UstaD15', APP_ID, API_HASH).start(bot_token=BOT_TOKEN15) 
else:
    UstaD15=None

if BOT_TOKEN16:
    UstaD16 = TelegramClient('UstaD16', APP_ID, API_HASH).start(bot_token=BOT_TOKEN16) 
else:
    UstaD16=None

if BOT_TOKEN17:
    UstaD17 = TelegramClient('UstaD17', APP_ID, API_HASH).start(bot_token=BOT_TOKEN17) 
else:
    UstaD17=None

if BOT_TOKEN18:
     UstaD18 = TelegramClient('UstaD18', APP_ID, API_HASH).start(bot_token=BOT_TOKEN18) 
else:
    UstaD18=None

if BOT_TOKEN19:
 UstaD19 = TelegramClient('UstaD19', APP_ID, API_HASH).start(bot_token=BOT_TOKEN19) 
else:
    UstaD19=None

if BOT_TOKEN20:
 UstaD20 = TelegramClient('UstaD20', APP_ID, API_HASH).start(bot_token=BOT_TOKEN20) 
else:
    UstaD20=None
