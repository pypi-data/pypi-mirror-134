...
class Interconnect(object):
    ...
    def run(self, send_task, consumer_task, pulsar_producer_topic, pulsar_consumer_topic, pulsar_consumer_name,
            rabbitmq_send_exchange, rabbitmq_send_routing_key, rabbitmq_consumer_exchange,
            rabbitmq_consumer_routing_key, durable=False, _async=True, send_callback=None,
            rabbitmq_thread_count=None, pulsar_thread_count=None,
            logger=None):
        """
        ...
        pool.submit(self.rabbitmq_to_pulsar, send_task, pulsar_producer_topic, rabbitmq_consumer_exchange,
                    rabbitmq_consumer_routing_key, durable=durable, rabbitmq_thread_count=rabbitmq_thread_count,
        ...
        pool.submit(self.pulsar_to_rabbitmq, consumer_task, pulsar_consumer_topic,
                    ...
                    durable=durable, pulsar_thread_count=pulsar_thread_count, logger=logger)
