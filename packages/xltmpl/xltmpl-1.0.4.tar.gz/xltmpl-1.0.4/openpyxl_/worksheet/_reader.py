...
from openpyxl_.xml.functions import iterparse

# package imports
from openpyxl_.cell import Cell, MergedCell
from openpyxl_.cell.text import Text
from openpyxl_.worksheet.dimensions import (
    ColumnDimension,
    RowDimension,
...
from openpyxl_.formatting.formatting import ConditionalFormatting
from openpyxl_.formula.translate import Translator
from openpyxl_.utils import (
    get_column_letter,
    coordinate_to_tuple,
    )
from openpyxl_.utils.datetime import from_excel, from_ISO8601, WINDOWS_EPOCH
...
class WorksheetReader(object):
    ...
    def bind_merged_cells(self):
        from openpyxl_.worksheet.cell_range import MultiCellRange
        from openpyxl_.worksheet.merge import MergedCellRange
