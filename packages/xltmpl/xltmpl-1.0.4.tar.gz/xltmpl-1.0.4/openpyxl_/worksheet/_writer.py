...
from openpyxl_.xml.functions import xmlfile
from openpyxl_.xml.constants import SHEET_MAIN_NS

from openpyxl_.comments.comment_sheet import CommentRecord
from openpyxl_.packaging.relationship import Relationship, RelationshipList
from openpyxl_.styles.differential import DifferentialStyle
...
from openpyxl_.cell._writer import write_cell
...
class WorksheetWriter:
    ...
    def write_sort(self):
        ...
        openpyxl_ never reads it from existing files
        """
        pass
