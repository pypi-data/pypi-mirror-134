...
from openpyxl_.formatting.formatting import ConditionalFormattingList
from openpyxl_.packaging.relationship import RelationshipList
from openpyxl_.workbook.child import _WorkbookChild
from openpyxl_.workbook.defined_name import COL_RANGE_RE, ROW_RANGE_RE
...
class Worksheet(_WorkbookChild):
    ...
    use :func:`openpyxl_.workbook.Workbook.create_sheet` instead
