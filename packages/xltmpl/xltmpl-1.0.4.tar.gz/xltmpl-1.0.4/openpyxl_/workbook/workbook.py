...
from openpyxl_.compat import deprecated
from openpyxl_.worksheet.worksheet import Worksheet
from openpyxl_.worksheet._read_only import ReadOnlyWorksheet
from openpyxl_.worksheet._write_only import WriteOnlyWorksheet
from openpyxl_.worksheet.copier import WorksheetCopy

from openpyxl_.utils import quote_sheetname
from openpyxl_.utils.indexed_list import IndexedList
from openpyxl_.utils.datetime  import WINDOWS_EPOCH, MAC_EPOCH
from openpyxl_.utils.exceptions import ReadOnlyWorkbookException

from openpyxl_.writer.excel import save_workbook

from openpyxl_.styles.cell_style import StyleArray
from openpyxl_.styles.named_styles import NamedStyle
from openpyxl_.styles.differential import DifferentialStyleList
from openpyxl_.styles.alignment import Alignment
from openpyxl_.styles.borders import DEFAULT_BORDER
from openpyxl_.styles.fills import DEFAULT_EMPTY_FILL, DEFAULT_GRAY_FILL
from openpyxl_.styles.fonts import DEFAULT_FONT
from openpyxl_.styles.protection import Protection
from openpyxl_.styles.colors import COLOR_INDEX
from openpyxl_.styles.named_styles import NamedStyleList
from openpyxl_.styles.table import TableStyleList

from openpyxl_.chartsheet import Chartsheet
from .defined_name import DefinedName, DefinedNameList
from openpyxl_.packaging.core import DocumentProperties
from openpyxl_.packaging.relationship import RelationshipList
...
from openpyxl_.xml.constants import (
    XLSM,
    XLSX,
    XLTM,
    XLTX
...
class Workbook(object):
    ...
    def active(self):
        ...
        :type: :class:`openpyxl_.worksheet.worksheet.Worksheet`
        """
        try:
    ...
    def worksheets(self):
        ...
        :type: list of :class:`openpyxl_.worksheet.worksheet.Worksheet`
        """
    ...
    def chartsheets(self):
        ...
        :type: list of :class:`openpyxl_.chartsheet.chartsheet.Chartsheet`
        """
    ...
    def mime_type(self):
        ...
        extension to match but openpyxl_ does not enforce this.
    ...
    def save(self, filename):
        ...
        .. warning::
            ...
            modify or save the file will raise an :class:`openpyxl_.shared.exc.WorkbookAlreadySaved` exception.
        """
        if self.read_only:
