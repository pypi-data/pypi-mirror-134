...
from openpyxl_.xml.functions import NS_REGEX, Element
from openpyxl_.xml.constants import CHART_NS, REL_NS, DRAWING_NS
...
from openpyxl_.chart.shapes import GraphicalProperties
from openpyxl_.chart.text import RichText
