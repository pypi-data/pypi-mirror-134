...
class Name(BaseObject):
    ...
    #: :class:`~xlrd_.formula.Operand` class.
    #
    result = None
    ...
    def cell(self):
        ...
        :returns: An instance of the :class:`~xlrd_.sheet.Cell` class.

        :raises xlrd_.biffh.XLRDError:
...
class Book(BaseObject):
    ...
    .. warning::
      ...
      object that was returned when you called :func:`~xlrd_.open_workbook`.
    """
    ...
    #: A list of :class:`~xlrd_.formatting.Font` class instances,
    #: each corresponding to a FONT record.
    #:
    #: .. versionadded:: 0.6.1
    font_list = []

    #: A list of :class:`~xlrd_.formatting.XF` class instances,
    #: each corresponding to an ``XF`` record.
    #:
    #: .. versionadded:: 0.6.1
    xf_list = []

    #: A list of :class:`~xlrd_.formatting.Format` objects, each corresponding to
    ...
    ##
    #: The mapping from :attr:`~xlrd_.formatting.XF.format_key` to
    #: :class:`~xlrd_.formatting.Format` object.
    #:
    #: .. versionadded:: 0.6.1
    format_map = {}
    ...
    def sheet_by_index(self, sheetx):
        ...
        :returns: A :class:`~xlrd_.sheet.Sheet`.
        """
    ...
    def __getitem__(self, item):
        ...
        :return: :class:`~xlrd_.sheet.Sheet`.
        """
