...
# This module is part of the xlrd_ package, which is released under a
# BSD-style licence.
...
class Sheet(BaseObject):
    ...
    .. warning::
      ...
      objects via the :class:`~xlrd_.book.Book` object that
      was returned when you called :func:`xlrd_.open_workbook`.
    """

    #: Name of sheet.
    name = ''

    #: A reference to the :class:`~xlrd_.book.Book` object to which this sheet
    #: belongs.
    #:
    ...
    #: See also the ``ragged_rows`` parameter to :func:`~xlrd_.open_workbook`
    #: and :meth:`~xlrd_.sheet.Sheet.row_len`.
    ncols = 0
    ...
    #:
    #: .. note::
    #:   xlrd_ ignores the entry for the non-existent
    #:   257th column.
    #:
    ...
    #: :attr:`~xlrd_.sheet.Sheet.hyperlink_list`.
    ...
    def __init__(self, book, position, name, number):
        ...
        # Values calculated by xlrd_ to predict the mag factors that
    ...
    def cell_xf_index(self, rowx, colx):
        ...
        This is an index into :attr:`~xlrd_.book.Book.xf_list`.
...
class Cell(BaseObject):
    ...
    .. warning::
      ...
      :class:`~xlrd_.book.Book` object that was returned when you called
      :func:`~xlrd_.open_workbook`
...
class Colinfo(BaseObject):
    ...
    xlrd_ goes with the GCW version of the story.
...
class Rowinfo(BaseObject):
    ...
    def __init__(self):
        ...
        #: parsed by xlrd_), *and* is collapsed.
        ...
        #: Index to default :class:`~xlrd_.formatting.XF` record for empty cells
