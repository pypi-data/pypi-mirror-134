...
def imprimeDEF():
        ...
        if daadReady:
                print(';', file=f)
                if english:
                        print('; DAAD Ready 0.5 specific definitions.', file=f)
                else:
                        print('; Definiciones específicas para DAAD Ready 0.5', file=f)
                print(';', file=f)
                if english:
...
print()
print('Triz2DAAD versión 1.0.4b5 220114 (c) 2019-22 Pedro Fernández')     
...
if daadReady:
        if english:
                print('-Exporting to a DAADReady 0.5 compatible template.')
        else:
                print('-Exportando a una plantilla comnpatible con DAADReady 0.5')
        dsf=True
        if statusLine:
                if english:
