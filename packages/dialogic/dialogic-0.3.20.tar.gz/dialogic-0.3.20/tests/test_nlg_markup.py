...
PARSED_RESPONSE = dict(
    markup='This markup be used in <text>Yandex.Dialogs</text><voice>Yandex Dialogs</voice> '
           'and other<accented> platforms.'
    ...
    expected_voice='This markup be used in Yandex Dialogs and other<[accented]> platforms.',
    expected_links=[{'title': 'Yandex.Dialogs site', 'url': 'https://dialogs.yandex.ru/'}],
)  # todo: find out whether the tag <[accented]> should go before or after a word
