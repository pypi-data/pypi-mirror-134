      ...
      Match_Ignore := False;
         ...
         begin
            ...
            case Input_Char is
               ...
               when 'B' .. 'A' | 'C' .. 'B' | 'D' .. 'C' | 'E' .. 'D' | 'F' .. 'E' | 'G' | 'I' .. 'H' | 'J' .. 'K' | 'M' .. 'N' | 'P' .. 'O' | 'Q' | 'S' .. 'R' | 'T' .. 'U' | 'W' .. 'V' | 'X' .. 'Z' | 'b' .. 'a' | 'c' .. 'd' | 'f' .. 'e' | 'g' .. 'f' | 'h' | 'j' .. 'l' | 'n' .. 'm' | 'o' .. 'n' | 'p' .. 'o' | 'q' | 's' .. 'r' | 't' .. 's' | 'u' .. 't' | 'v' | 'x' .. 'z' => goto State_21;
         ...
         begin
            ...
            case Input_Char is
               when Character_Type'Val (16#9#) .. Character_Type'Val (16#a#) | Character_Type'Val (16#d#) | ' ' => goto State_53;
         ...
         begin
            ...
            case Input_Char is
               when Character_Type'Val (16#0#) .. '!' | '#' .. Character_Type'Val (16#10ffff#) => goto State_54;
               when '"' => goto State_55;
         ...
         begin
            ...
            case Input_Char is
               when '#' => goto State_60;
               when '0' .. '9' => goto State_61;
               when '_' => goto State_62;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'x' | 'z' => goto State_68;
               when 'y' => goto State_70;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'b' .. 'd' | 'f' .. 'h' | 'j' .. 'z' => goto State_68;
               when 'a' => goto State_75;
               when 'e' => goto State_76;
               when 'i' => goto State_77;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'b' .. 'n' | 'p' .. 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'm' | 'o' .. 'w' | 'y' .. 'z' => goto State_68;
               when 'n' => goto State_90;
               when 'x' => goto State_91;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'd' | 'f' .. 'n' | 'p' .. 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'e' | 'g' .. 'm' | 'o' .. 'r' | 't' .. 'z' => goto State_68;
               when 'f' => goto State_96;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'd' | 'f' .. 'n' | 'p' .. 't' | 'v' .. 'z' => goto State_68;
               when 'e' => goto State_101;
               when 'o' => goto State_102;
               when 'u' => goto State_103;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'e' | 'g' .. 'q' | 's' .. 'z' => goto State_68;
               when 'f' => goto State_104;
               when 'r' => goto State_105;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'b' .. 'q' | 's' .. 'z' => goto State_68;
               when 'a' => goto State_106;
               when 'r' => goto State_107;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'b' .. 'd' | 'f' .. 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'd' | 'f' .. 'n' | 'p' .. 's' | 'u' .. 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'g' | 'i' .. 'q' | 's' .. 'x' | 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'g' | 'i' .. 'h' | 'j' .. 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'm' | 'o' .. 'q' | 's' .. 'z' => goto State_68;
               when 'n' => goto State_129;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'f' | 'h' .. 'z' => goto State_68;
               when 'g' => goto State_133;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'v' | 'x' .. 'z' => goto State_68;
               when 'w' => goto State_136;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'b' .. 'r' | 't' .. 'z' => goto State_68;
               when 'a' => goto State_139;
               when 's' => goto State_140;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'y' => goto State_68;
               when 'z' => goto State_141;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'm' | 'o' .. 's' | 'u' .. 'z' => goto State_68;
               when 'n' => goto State_161;
               when 't' => goto State_162;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'p' | 'r' | 't' .. 'z' => goto State_68;
               when 'q' => goto State_163;
               when 's' => goto State_164;
         ...
         begin
            ...
            case Input_Char is
               when '#' => goto State_173;
               when '0' .. '9' | 'A' .. 'F' => goto State_174;
               when '_' => goto State_175;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | 'a' .. 'z' => goto State_68;
               when '_' => goto State_185;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'p' | 'r' .. 'z' => goto State_68;
               when 'q' => goto State_191;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'n' | 'p' .. 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'Z' | '_' | 'a' .. 'j' | 'l' .. 'z' => goto State_68;
               when 'k' => goto State_205;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'C' | 'E' .. 'Z' | '_' | 'a' .. 'z' => goto State_68;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'N' | 'P' .. 'Z' | '_' | 'a' .. 'z' => goto State_68;
               when 'O' => goto State_231;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'B' | 'D' .. 'Z' | '_' | 'a' .. 'z' => goto State_68;
               when 'C' => goto State_289;
         ...
         begin
            ...
            case Input_Char is
               when '0' .. '9' | 'A' .. 'E' | 'G' .. 'Z' | '_' | 'a' .. 'z' => goto State_68;
