...
class Client(ProjectApi):
    ...
    def create_attachments(
        ...
        :return: The json structure
        """
        return AttachmentApi(self._config["_token"]).post_attachment(artifact_type, artifact_version, files)
    ...
    def update_attachments(
        ...
        :return: The json structure
        """
        return AttachmentApi(self._config["_token"]).update_attachments(artifact_type, artifact_version, files)
    ...
    def list_connections(
        ...
        :return: The json structure
        """
        return ConnectionApi(self._config["_token"]).list_connections(
            search_name=search_name, connection_type=connection_type
        )
