...
from lpaas_client.sync.routes.theories import TheoriesClient
...
class TestTheoriesClient(TestCase):
    ...
    @respx.mock
    def test_add_new_fact_to_theory(self):
        ...
        response = self.client.add_new_fact_to_theory(theory_name, parse_clause(facts_p_str[0]))
    ...
    def test_create_theory(self):
        ...
        response = self.client.add_new_theory(theory_name, theory)
    ...
    def test_update_theory(self):
        ...
        response = self.client.add_new_theory_version(
    ...
    def test_get_theories(self):
        ...
        response = self.client.get_theories()
    ...
    def test_get_theory(self):
        ...
        response = self.client.get_theory(theory_name)
    ...
    @respx.mock
    def test_get_theory_facts(self):
