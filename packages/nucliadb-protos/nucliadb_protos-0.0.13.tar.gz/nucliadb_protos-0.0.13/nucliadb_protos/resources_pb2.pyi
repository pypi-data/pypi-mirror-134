...
class Message(google.protobuf.message.Message):
    ...
    @property
    def files(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CloudFile]: ...
    def __init__(self,
        *,
        text : typing.Text = ...,
        format : global___Message.Format.V = ...,
        files : typing.Optional[typing.Iterable[global___CloudFile]] = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["files",b"files","format",b"format","text",b"text"]) -> None: ...
...
class FieldKeywords(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
...
global___FieldKeywords = FieldKeywords
