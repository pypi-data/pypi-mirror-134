...
class QueryManager:
    def __init__(self,
        ...
        self.sparql = SPARQLStore(query_endpoint=self.endpoint,
    ...
    def dispatch_sparql_query(self, raw_sparql_query, request_args, return_format=JSONLD):
        ...
        rewritten_query = prepareQuery(raw_sparql_query)
        response = self.sparql.query(rewritten_query, DEBUG=True)
