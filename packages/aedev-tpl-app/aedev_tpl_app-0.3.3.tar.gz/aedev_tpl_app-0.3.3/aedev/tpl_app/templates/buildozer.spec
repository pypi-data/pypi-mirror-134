...
requirements = hostpython3==3.7.5, python3==3.7.5, kivy==2.0.0rc3, plyer,
    ae.base, ae.droid, ae.paths, ae.files, ae.deep, ae.inspector, ae.i18n, ae.updater, ae.core, ae.literal, ae.console,
