...
def LaunchTemplates(stem, props, sg_ids=None, vpc_id=None, snet_ids=None, iam_ip_arn=None, provider=None, parent=None, depends_on=None):
    lt =  ec2_classic.LaunchTemplate(
        f'lt-{stem}',
        # image_id='ami-07fe7e9426c49a76a',
        image_id='ami-0a98db1c4a78bcc78',
        ...
        user_data="IyEvYmluL2Jhc2gKZWNobyBFQ1NfQ0xVU1RFUj1lY3NDbHVzdGVyLVNFVEZsb3ctZGV2ID4+IC9ldGMvZWNzL2Vjcy5jb25maWc=",
        opts=ResourceOptions(provider=provider, parent=parent, depends_on=depends_on)
    )
    return lt