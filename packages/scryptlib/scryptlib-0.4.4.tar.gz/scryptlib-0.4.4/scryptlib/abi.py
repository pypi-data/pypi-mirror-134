...
class FunctionCall:
    ...
    def __init__(self, method_name, params, contract, unlocking_script=None):
        ...
        self._tx_input_context = utils.create_dummy_input_context()
    ...
    def verify(self, tx_input_context=None, interpreter_limits=None, custom_locking_script=None,
        ...
        if not tx_input_context:
            tx_input_context = self._tx_input_context
        ...
        if use_contract_script_pair:
            ...
            ls = custom_locking_script if custom_locking_script else self.contract.locking_script
            tx_input_context.utxo.script_pubkey = ls
