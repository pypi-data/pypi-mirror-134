...
class PetraMachineAdapter(PetraAdapter):
    def __init__(self, energy=6.063, bpm_unit='mm', path_to_bpm_calibr_file='src/ml_pipe_core/adapter/bpm_settings', path_to_constants_file='constants.csv', db_connector=SqlDBConnector(user=MYSQL_USER, pw=MYSQL_PW, host=MYSQL_HOST, port=MYSQL_PORT, database='sim_db')):
