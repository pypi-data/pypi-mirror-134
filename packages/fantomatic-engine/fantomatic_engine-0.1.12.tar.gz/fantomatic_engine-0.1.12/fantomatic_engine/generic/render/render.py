...
class Render:
    def __init__(self, rendering_surface: pygame.Surface):
        ...
        self.font_cta = pygame.font.SysFont("mono", 30, True)
        self.font_dialog = pygame.font.SysFont("mono", 20)
        self.font_small = pygame.font.SysFont("mono", 16)

        self.font_menu = pygame.font.SysFont("mono", 40, True)
        self.font_menu_secondary = pygame.font.SysFont("mono", 30)
        self.font_menu_read_only = pygame.font.SysFont("mono", 25)
        self.font_menu_small = pygame.font.SysFont("mono", 20)

        self.font_menu_file_explorer_dirname = pygame.font.SysFont("mono", 20)
        self.font_menu_notification = pygame.font.SysFont("mono", 25)
