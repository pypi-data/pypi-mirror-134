...
#from analytics_sdk import OAPDash    #extra import
...
#from analytics_apps import engine
...
class ExcelRenderer:
    ...
    def render(self):
       ...
       # run_data = ({'sheets': [{'title': 'Overview', 'header': {}, 'components': [{'data': [['Managed Resource Count'], [21873]], 'type': 'table', 'title': 'Managed Resources', 'title-color': 'red', 'start-row': 1, 'start-col': 1}, {'data': [('ResourceType', 'Count'), ('Windows', 10155), ('Linux', 5120), (None, 3527), ('CONTAINERD_CONTAINER', 375), ('SYNTHETIC', 221), ('Other', 2475)], 'type': 'doughnut-chart', 'start-col': 1, 'start-row': 5, 'chart-title': 'Top Resource Types', 'title-color': 'red', 'chart-position': 'E8', 'height': 6, 'width': 16}, {'data': [('Client Id', 'Resources Count'), ('client_812803', 6637), ('2b1811bf-a79a-435e-86a3-9ac82b4bf0ed', 5000), ('client_812371', 3453), ('client_486657', 2334), ('client_726410', 986), ('Other', 3463)], 'type': 'doughnut-chart', 'start-col': 1, 'start-row': 22, 'chart-title': 'Breakdown Top Clients Managed Resources', 'title-color': 'red', 'chart-position': 'E25', 'height': 6, 'width': 16}, {'data': [('Public Cloud', 'Count'), ('Data Center', 19987), ('Public Cloud', 1886)], 'type': 'doughnut-chart', 'start-col': 1, 'start-row': 40, 'chart-title': 'Public Cloud And Data Center', 'title-color': 'red', 'chart-position': 'E43', 'height': 6, 'width': 16}, {'data': [('Make', 'Count'), ('Azure', 918), ('Aws', 690), ('Google', 262), ('Google', 15), ('Google\n', 1)], 'type': 'doughnut-chart', 'start-col': 1, 'start-row': 58, 'chart-title': 'Resource Composition Public Cloud', 'title-color': 'red', 'chart-position': 'E61', 'height': 6, 'width': 16}, {'data': [('Operating System', 'Count'), (None, 44), ('Ubuntu', 3), ('Windows', 3), ('Other', 2), ('RHEL 8.2', 2), ('active-directory-2019 active-directory-win-2019', 1), ('redhat', 1), ('windows', 1), ('windows10', 1)], 'type': 'doughnut-chart', 'start-col': 1, 'start-row': 76, 'chart-title': 'Breakdown By Operating Operating', 'title-color': 'red', 'chart-position': 'E79', 'height': 6, 'width': 16}]}]})
