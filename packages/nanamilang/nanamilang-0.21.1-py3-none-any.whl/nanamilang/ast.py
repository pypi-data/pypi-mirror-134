...
class AST:
    ...
    from nanamilang.bdb import BuiltinFunctionsDB, BuiltinMacrosDB
    from nanamilang.builtin import BuiltinMacros, BuiltinFunctions
    BuiltinMacrosDB.initialize(BuiltinMacros) # => required step
    BuiltinFunctions.initialize(BuiltinFunctions) # => required step
    ...
    results = ast.evaluate() # will produce an (<IntegerNumber>: 8, )
    ```
    """
