...
# off we go
print(f'run segmentation predicting: {poke_s_task} {poke_s_slide_pxscene} {poke_es_seg_marker} ...')
...
if poke_s_task in {'cell', 'nuccell'}:
    print(f'segmenting cells: {poke_s_slide_pxscene} {poke_es_seg_marker}')
