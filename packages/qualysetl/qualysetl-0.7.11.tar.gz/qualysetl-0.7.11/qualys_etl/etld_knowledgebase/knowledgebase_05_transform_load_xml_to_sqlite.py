...
SUBSTR(json_each.value, INSTR(json_each.value,'CVE'), 20) AS CVE_LIST_ITEM_PREFIX,
INSTR(SUBSTR(json_each.value, INSTR(json_each.value,'CVE'), 20),'","') as CVE_LIST_ITEM_PREFIX_LENGTH 
