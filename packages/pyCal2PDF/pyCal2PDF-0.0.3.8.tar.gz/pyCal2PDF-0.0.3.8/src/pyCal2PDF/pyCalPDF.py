            ...
            for event in events:
                ...
                if len(content)>0:
                    ...
                    if drawing is None:
                        ...
                        warn_fp = abspath(join(__file__,pardir,pardir,"rsc","Warning.svg"))
