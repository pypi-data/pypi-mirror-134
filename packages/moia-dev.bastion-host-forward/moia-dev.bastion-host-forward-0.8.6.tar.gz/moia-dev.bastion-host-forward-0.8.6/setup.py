    ...
    """
{
    ...
    "package_data": {
        "moia_dev.bastion_host_forward._jsii": [
            "bastion-host-forward@0.8.6.jsii.tgz"
        ],
        "moia_dev.bastion_host_forward": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-ec2>=1.137.0, <2.0.0",
        "aws-cdk.aws-elasticache>=1.137.0, <2.0.0",
        "aws-cdk.aws-iam>=1.137.0, <2.0.0",
        "aws-cdk.aws-rds>=1.137.0, <2.0.0",
        "aws-cdk.aws-redshift>=1.137.0, <2.0.0",
