...
test = clf_within_ROI(r'Z:\DeepLabCut\DLC_extract\Troubleshooting\DLC_two_mice\project_folder\project_config.ini')

from collections import defaultdict

ROI_dict_lists = defaultdict(list)
ROI_dict_lists['Rectangle'] = ['Rec_1', 'Rec_2']
behavior_list = ['Attack']
body_part_list = ['Nose_1']

test.perform_ROI_clf_analysis(ROI_dict_lists, behavior_list, body_part_list)
