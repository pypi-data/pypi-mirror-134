...
class FileSpec(object):
    ...
    def __init__(self, attributes=None, description=None, meta=None, name=None, path=None, local_vars_configuration=None):  # noqa: E501
    ...
    def path(self):
        ...
        :return: The path of this FileSpec. 
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        ...
        :param path: The path of this FileSpec.
        :type: str
        """
