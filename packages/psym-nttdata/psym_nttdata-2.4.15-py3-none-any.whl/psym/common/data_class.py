...
class alarmFilter(NamedTuple):
    """
    :param name: Name
    :type name: str
    :param id: id
    :type id: str
    :param networkResource: networkResource
    :type networkResource: str
    :param enable: enable
    :type enable: bool
    :param beginTime: beginTime
    :type beginTime: DateTime   
    :param endTime: endTime
    ...
    :param creationTime: creationTime
    :type creationTime: DateTime  
    :param alarmStatus: alarmStatus
    :type alarmStatus: `~psym.common.data_class.alarmStatus`
    """
