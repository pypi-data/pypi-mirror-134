...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, total_timeout=None, sock_read_timeout=None, rate_limit=None, ca_cert=None, tls_validation=None, connect_timeout=None, pulp_labels=None, pulp_created=None, name=None, download_concurrency=None, client_cert=None, url=None, proxy_url=None, headers=None, max_retries=None, sock_connect_timeout=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
