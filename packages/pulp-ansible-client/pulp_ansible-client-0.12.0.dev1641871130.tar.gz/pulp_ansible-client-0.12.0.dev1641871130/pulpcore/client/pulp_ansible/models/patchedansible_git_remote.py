...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, url=None, rate_limit=None, username=None, headers=None, sock_connect_timeout=None, proxy_username=None, sock_read_timeout=None, proxy_password=None, max_retries=None, connect_timeout=None, client_cert=None, password=None, total_timeout=None, download_concurrency=None, proxy_url=None, name=None, tls_validation=None, client_key=None, pulp_labels=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
