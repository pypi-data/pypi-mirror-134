...
class AnsibleGitRemote(object):
    ...
    def __init__(self, max_retries=None, headers=None, client_cert=None, proxy_username=None, connect_timeout=None, total_timeout=None, download_concurrency=None, ca_cert=None, url=None, proxy_url=None, pulp_labels=None, client_key=None, sock_connect_timeout=None, proxy_password=None, name=None, sock_read_timeout=None, password=None, rate_limit=None, tls_validation=None, username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
