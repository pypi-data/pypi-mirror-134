...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, tls_validation=None, client_cert=None, headers=None, pulp_created=None, sock_connect_timeout=None, ca_cert=None, pulp_labels=None, sock_read_timeout=None, max_retries=None, connect_timeout=None, pulp_last_updated=None, total_timeout=None, url=None, proxy_url=None, name=None, rate_limit=None, download_concurrency=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
