...
class AnsibleGitRemote(object):
    ...
    def __init__(self, password=None, tls_validation=None, client_cert=None, headers=None, proxy_username=None, username=None, sock_connect_timeout=None, ca_cert=None, pulp_labels=None, sock_read_timeout=None, client_key=None, proxy_password=None, max_retries=None, connect_timeout=None, total_timeout=None, url=None, proxy_url=None, name=None, rate_limit=None, download_concurrency=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
