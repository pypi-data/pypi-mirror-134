...
class AnsibleGitRemote(object):
    ...
    def __init__(self, connect_timeout=None, headers=None, pulp_labels=None, client_cert=None, max_retries=None, url=None, client_key=None, name=None, rate_limit=None, proxy_password=None, sock_read_timeout=None, ca_cert=None, password=None, sock_connect_timeout=None, tls_validation=None, proxy_username=None, total_timeout=None, username=None, download_concurrency=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
