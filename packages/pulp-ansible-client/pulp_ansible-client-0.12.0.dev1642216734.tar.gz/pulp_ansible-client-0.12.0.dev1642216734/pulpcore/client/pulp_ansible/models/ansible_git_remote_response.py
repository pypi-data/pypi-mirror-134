...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, connect_timeout=None, headers=None, pulp_labels=None, client_cert=None, max_retries=None, url=None, pulp_last_updated=None, name=None, rate_limit=None, sock_read_timeout=None, pulp_href=None, ca_cert=None, pulp_created=None, sock_connect_timeout=None, tls_validation=None, total_timeout=None, download_concurrency=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
