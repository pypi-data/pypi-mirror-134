...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_created=None, download_concurrency=None, headers=None, pulp_last_updated=None, rate_limit=None, ca_cert=None, name=None, pulp_href=None, sock_read_timeout=None, max_retries=None, connect_timeout=None, sock_connect_timeout=None, total_timeout=None, url=None, pulp_labels=None, client_cert=None, proxy_url=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
