...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_username=None, download_concurrency=None, password=None, headers=None, rate_limit=None, ca_cert=None, name=None, sock_read_timeout=None, client_key=None, max_retries=None, connect_timeout=None, sock_connect_timeout=None, total_timeout=None, url=None, username=None, proxy_password=None, pulp_labels=None, client_cert=None, proxy_url=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
