...
class AnsibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, ca_cert=None, max_retries=None, headers=None, password=None, tls_validation=None, total_timeout=None, name=None, proxy_password=None, client_cert=None, sock_connect_timeout=None, download_concurrency=None, client_key=None, sock_read_timeout=None, pulp_labels=None, rate_limit=None, connect_timeout=None, username=None, url=None, proxy_username=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
