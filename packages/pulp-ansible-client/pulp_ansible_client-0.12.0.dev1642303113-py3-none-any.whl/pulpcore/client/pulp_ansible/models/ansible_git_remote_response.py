...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, ca_cert=None, max_retries=None, headers=None, pulp_created=None, pulp_href=None, tls_validation=None, total_timeout=None, name=None, client_cert=None, sock_connect_timeout=None, download_concurrency=None, sock_read_timeout=None, pulp_labels=None, rate_limit=None, connect_timeout=None, pulp_last_updated=None, url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
