...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, rate_limit=None, headers=None, sock_connect_timeout=None, sock_read_timeout=None, pulp_last_updated=None, pulp_created=None, max_retries=None, connect_timeout=None, client_cert=None, total_timeout=None, download_concurrency=None, proxy_url=None, name=None, tls_validation=None, pulp_labels=None, ca_cert=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
