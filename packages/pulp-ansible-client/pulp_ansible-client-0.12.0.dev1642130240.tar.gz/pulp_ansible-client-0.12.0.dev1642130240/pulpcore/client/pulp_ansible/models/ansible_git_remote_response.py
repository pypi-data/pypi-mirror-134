...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, client_cert=None, sock_read_timeout=None, total_timeout=None, sock_connect_timeout=None, pulp_created=None, max_retries=None, name=None, rate_limit=None, pulp_href=None, download_concurrency=None, connect_timeout=None, tls_validation=None, url=None, headers=None, ca_cert=None, pulp_labels=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
