...
class AnsibleGitRemote(object):
    ...
    def __init__(self, client_key=None, total_timeout=None, sock_read_timeout=None, rate_limit=None, ca_cert=None, tls_validation=None, connect_timeout=None, pulp_labels=None, name=None, password=None, proxy_password=None, download_concurrency=None, client_cert=None, username=None, url=None, proxy_url=None, headers=None, max_retries=None, proxy_username=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
