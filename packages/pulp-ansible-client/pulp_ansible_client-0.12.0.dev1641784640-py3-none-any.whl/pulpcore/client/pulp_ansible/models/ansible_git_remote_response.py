...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, max_retries=None, pulp_href=None, headers=None, client_cert=None, pulp_created=None, pulp_last_updated=None, connect_timeout=None, total_timeout=None, download_concurrency=None, ca_cert=None, url=None, proxy_url=None, pulp_labels=None, sock_connect_timeout=None, name=None, sock_read_timeout=None, rate_limit=None, tls_validation=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
