...
from tecton.interactive.feature_definition import KEY_DELETION_MAX
...
INCORRECT_KEYS = lambda keys: TectonValidationError(f"The given keys do not match the keys {keys} required.")
