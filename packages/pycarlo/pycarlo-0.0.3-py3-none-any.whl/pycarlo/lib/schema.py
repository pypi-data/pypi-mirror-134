...
class Account(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('id', 'uuid', 'name', 'created_on', 'config', 'allow_non_sso_login', 'notification_settings', 'data_collectors', 'users', 'user_invites', 'warehouses', 'bi', 'tableau_accounts', 'slack_credentials', 'slack_msg_details', 'resources', 'slack_credentials_v2', 'identity_provider', 'active_collection_regions')
...
class ICustomRulesMonitor(sgqlc.types.Interface):
    __schema__ = schema
    __field_names__ = ('has_custom_rule_name', 'rule_description', 'rule_comparisons', 'is_snoozed', 'snooze_until_time', 'slack_snooze_user')
