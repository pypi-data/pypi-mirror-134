...
explatory.check_outlier(df, col_name)
    ...
    low_limit, up_limit = vboUtil.preprocessing.outlier_thresholds(df, col_name, lower, upper)
...
explatory.grab_outliers(df, col_name)
    ...
    low, up = vboUtil.preprocessing.outlier_thresholds(df, col_name, lower, upper)
