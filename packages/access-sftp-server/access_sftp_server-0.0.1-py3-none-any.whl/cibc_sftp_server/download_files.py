...
import os
import time
import manipulate_reports

from accessOutlookEmail import create_account, send_email
from sftp_connection import establishConnection, sftpConnection
global sftp
global server
...
weekend = (datetime.date.today() - datetime.timedelta(3)).strftime("%Y%m%d")
todaysReports = set()
