...
import time
import numpy as np
from INFO import REQUEST_URL, BODY, USER_AGENTS, RESPONSE_CODE_WEIGHT_DICT, REQUEST_TYPE_WEIGHT_DICT
...
class InstacartLogGenerator:
    ...
    def __init__(self):
        ...
        self.info = np.load('sample.npy', allow_pickle=True)
...
InstacartLogGenerator().logging('f.log', 1)