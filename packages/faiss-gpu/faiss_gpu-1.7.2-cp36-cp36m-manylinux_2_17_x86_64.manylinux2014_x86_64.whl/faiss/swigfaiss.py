...
r""" Unknown allocation type or miscellaneous (not currently categorized)"""
...
r""" Quantizer (PQ, SQ) dictionary information"""
...
class GpuResourcesProvider(object):
    r""" Interface for a provider of a shared resources object"""
...
class GpuIndexIVF(GpuIndex):
    ...
    def getQuantizer(self):
        r""" Return the quantizer we're using"""
        return _swigfaiss.GpuIndexIVF_getQuantizer(self)

    def setNumProbes(self, nprobe):
        r""" Sets the number of list probes per query"""
        return _swigfaiss.GpuIndexIVF_setNumProbes(self, nprobe)

    def getNumProbes(self):
        r""" Returns our current number of list probes per query"""
        return _swigfaiss.GpuIndexIVF_getNumProbes(self)
    cp = property(_swigfaiss.GpuIndexIVF_cp_get, _swigfaiss.GpuIndexIVF_cp_set, doc=r""" Exposing this like the CPU version for manipulation""")
    nlist = property(_swigfaiss.GpuIndexIVF_nlist_get, _swigfaiss.GpuIndexIVF_nlist_set, doc=r""" Exposing this like the CPU version for query""")
    nprobe = property(_swigfaiss.GpuIndexIVF_nprobe_get, _swigfaiss.GpuIndexIVF_nprobe_set, doc=r""" Exposing this like the CPU version for manipulation""")
    quantizer = property(_swigfaiss.GpuIndexIVF_quantizer_get, _swigfaiss.GpuIndexIVF_quantizer_set, doc=r""" Exposeing this like the CPU version for query""")
