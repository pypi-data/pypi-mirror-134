...
class Ui_CameraControl(object):
    def setupUi(self, CameraControl):
        ...
        self.takeScreenshotButton = QtWidgets.QPushButton(CameraControl)
        self.takeScreenshotButton.setEnabled(False)
    ...
    def retranslateUi(self, CameraControl):
        ...
        self.takeScreenshotButton.setText(_translate("CameraControl", "Take Screenshot"))
