    ...
    if python_version == python_37:
        ...
        def speech_to_text():
            ...
            try:
                ...
                import os
                cmd = 'https://download.lfd.uci.edu/pythonlibs/x6hvwk7i/PyAudio-0.2.11-cp37-cp37m-win_amd64.whl'
        ...
        def speech_to_text():
            ...
            try:
                ...
                import os
                cmd = 'https://download.lfd.uci.edu/pythonlibs/x6hvwk7i/PyAudio-0.2.11-cp38-cp38-win_amd64.whl'
                os.system(f'"{python_exe_path_ut}" -m pip install ' + cmd)
                import pyaudio
            import speech_recognition as sr
            from clointfusion.clointfusion import clear_screen
    ...
    # Windows OS - Python 3.9
        ...
        def speech_to_text():
            ...
            try:
                ...
                import os
                cmd = 'https://download.lfd.uci.edu/pythonlibs/x6hvwk7i/PyAudio-0.2.11-cp39-cp39-win_amd64.whl'
                os.system(f'"{python_exe_path_ut}" -m pip install ' + cmd)
                import pyaudio
            import speech_recognition as sr
            from clointfusion.clointfusion import clear_screen
