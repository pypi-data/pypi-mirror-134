...
class RouterProcess:
    ...
    @staticmethod
    def __incoming_message(connection, router, message):
            ...
            for index, (connection, router) in enumerate(self.connections):
                try:
                    if connection.state == Connection.State.Open:
                        ...
                        if message:
                            new_thread = Thread(target=RouterProcess.__incoming_message, args=(connection, router, message))
                            new_thread.start()
                            self.incoming_messages_threads.append(new_thread)
                    else:
