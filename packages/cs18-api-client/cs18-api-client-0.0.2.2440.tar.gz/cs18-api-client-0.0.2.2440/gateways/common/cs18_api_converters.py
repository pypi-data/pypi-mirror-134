...
class Converters:
    ...
    def create_space_helm_chart_response(data: dict) -> SpaceHelmChartModuleResponse:
        return SpaceHelmChartModuleResponse(
            name=data["chart_descriptor"]["name"],
            perform_helm_test=data["chart_descriptor"]["perform_helm_test"],
            enable_logs=data["chart_descriptor"]["enable_logs"],
            inputs=[Converters.convert_space_helm_chart_input(input_item) for input_item
                    in data["chart_descriptor"]["inputs"]],
            outputs=[Converters.convert_space_helm_chart_output(output_item) for output_item
                     in data["chart_descriptor"]["outputs"]],
            compute_service=Converters.convert_space_helm_chart_compute_service(
                data["chart_descriptor"]["compute_service"]),
            chart_root_path=data["chart_descriptor"]["chart_root_path"],
            override_values_yaml=data["chart_descriptor"]["override_values_yaml"],
            description=data["chart_descriptor"]["description"],
            created_by=data["created_by"],
            created_date=data["created_date"],
            modified_by=data["modified_by"],
            last_modified=data["last_modified"]
