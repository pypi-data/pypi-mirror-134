...
class OnlineSimulator():
    ...
    def run(self, config, dataObj, rankers):
        ...
        for i in tqdm(range(config.rounds)):
            ...
            user_ids = np.array([dataObj.userid_mapped_data['4486'], dataObj.userid_mapped_data['4159']])#np.random.choice(range(dataObj.n_users), config.n_users_per_round, replace=False)
