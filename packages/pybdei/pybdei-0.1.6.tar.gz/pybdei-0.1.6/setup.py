...
bdei_module = Extension('_pybdei',
                        compiler="g++",
                        sources=['pybdei/_pybdei.cpp', 'include/BDEI.cpp'],
                        include_dirs=['include', 'pybdei'],
                        package_data={'_pybdei': [os.path.join('pybdei', '*.hpp'), os.path.join('include', '*.hpp')]},
                        depends=['pybdei/_pybdei.hpp', 'pybdei/_python.hpp',
                                 'include/BDEI.hpp', 'include/pool.hpp', 'include/queue.hpp', 'include/semaphore.hpp'],
                        libraries=['nlopt'],
