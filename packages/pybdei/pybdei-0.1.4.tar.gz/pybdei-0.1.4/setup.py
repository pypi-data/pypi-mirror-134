...
bdei_module = Extension('_pybdei',
                        compiler="g++",
                        sources=['pybdei/_pybdei.cpp', 'include/BDEI.cpp', 'pybdei/_pybdei.hpp', 'pybdei/_python.hpp', 'include/BDEI.hpp', 'include/pool.hpp', 'include/queue.hpp', 'include/semaphore.hpp'],
