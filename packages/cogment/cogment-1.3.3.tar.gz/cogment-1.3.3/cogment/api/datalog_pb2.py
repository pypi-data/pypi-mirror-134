...
_TRIALDATA = _descriptor.Descriptor(
  name='TrialData',
  full_name='cogment.TrialData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='tick_id', full_name='cogment.TrialData.tick_id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='cogment.TrialData.timestamp', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='state', full_name='cogment.TrialData.state', index=2,
...
_DATALOGSAMPLE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='trial_data', full_name='cogment.DatalogSample.trial_data', index=5,
...
_TRIALDATA.fields_by_name['state'].enum_type = cogment_dot_api_dot_common__pb2._TRIALSTATE
...
_DATALOGSAMPLE.fields_by_name['trial_data'].message_type = _TRIALDATA
DESCRIPTOR.message_types_by_name['LogExporterSampleRequest'] = _LOGEXPORTERSAMPLEREQUEST
DESCRIPTOR.message_types_by_name['TrialData'] = _TRIALDATA
...
TrialData = _reflection.GeneratedProtocolMessageType('TrialData', (_message.Message,), {
  'DESCRIPTOR' : _TRIALDATA,
  '__module__' : 'cogment.api.datalog_pb2'
  # @@protoc_insertion_point(class_scope:cogment.TrialData)
  })
_sym_db.RegisterMessage(TrialData)
