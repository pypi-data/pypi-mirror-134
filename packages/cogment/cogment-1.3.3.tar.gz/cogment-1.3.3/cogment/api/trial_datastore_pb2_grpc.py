...
class TrialDatastoreSPStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RetrieveTrials = channel.unary_unary(
                '/cogment.TrialDatastoreSP/RetrieveTrials',
        ...
        self.RetrieveSamples = channel.unary_stream(
                '/cogment.TrialDatastoreSP/RetrieveSamples',
        ...
        self.AddTrial = channel.unary_unary(
                '/cogment.TrialDatastoreSP/AddTrial',
        ...
        self.AddSample = channel.stream_unary(
                '/cogment.TrialDatastoreSP/AddSample',
        ...
        self.DeleteTrials = channel.unary_unary(
                '/cogment.TrialDatastoreSP/DeleteTrials',
...
def add_TrialDatastoreSPServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cogment.TrialDatastoreSP', rpc_method_handlers)
...
class TrialDatastoreSP(object):
    ...
    def RetrieveTrials(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cogment.TrialDatastoreSP/RetrieveTrials',
    ...
    def RetrieveSamples(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/cogment.TrialDatastoreSP/RetrieveSamples',
    ...
    def AddTrial(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cogment.TrialDatastoreSP/AddTrial',
    ...
    def AddSample(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/cogment.TrialDatastoreSP/AddSample',
    ...
    def DeleteTrials(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cogment.TrialDatastoreSP/DeleteTrials',
