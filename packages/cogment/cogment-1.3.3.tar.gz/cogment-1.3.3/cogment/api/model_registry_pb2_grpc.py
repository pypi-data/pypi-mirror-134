...
class ModelRegistrySPStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateOrUpdateModel = channel.unary_unary(
                '/cogment.ModelRegistrySP/CreateOrUpdateModel',
        ...
        self.DeleteModel = channel.unary_unary(
                '/cogment.ModelRegistrySP/DeleteModel',
        ...
        self.RetrieveModels = channel.unary_unary(
                '/cogment.ModelRegistrySP/RetrieveModels',
        ...
        self.CreateVersion = channel.stream_unary(
                '/cogment.ModelRegistrySP/CreateVersion',
        ...
        self.RetrieveVersionInfos = channel.unary_unary(
                '/cogment.ModelRegistrySP/RetrieveVersionInfos',
        ...
        self.RetrieveVersionData = channel.unary_stream(
                '/cogment.ModelRegistrySP/RetrieveVersionData',
...
def add_ModelRegistrySPServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'cogment.ModelRegistrySP', rpc_method_handlers)
...
class ModelRegistrySP(object):
    ...
    def CreateOrUpdateModel(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cogment.ModelRegistrySP/CreateOrUpdateModel',
    ...
    def DeleteModel(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cogment.ModelRegistrySP/DeleteModel',
    ...
    def RetrieveModels(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cogment.ModelRegistrySP/RetrieveModels',
    ...
    def CreateVersion(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/cogment.ModelRegistrySP/CreateVersion',
    ...
    def RetrieveVersionInfos(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cogment.ModelRegistrySP/RetrieveVersionInfos',
    ...
    def RetrieveVersionData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/cogment.ModelRegistrySP/RetrieveVersionData',
