...
from banner.utils.neware import calculate_current, calculate_dq_dv, calculate_neware_columns, calculate_neware_timestamp, calculate_temperature, calculate_voltage, group_by_auxchl
...
DataFrame.calculate_dq_dv = calculate_dq_dv
