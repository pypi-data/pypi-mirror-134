...
class FeatureStore:
    ...
    def get_history_feature(self, label_table_info: dict,
                            feature_refs: List[str], dts: str, user: str,result_table_name:str,is_local:bool) -> sql.dataframe:
        ...
        if not is_local:
            ...
            table_exists = result_table_name.split('.')[1] in self.spark_session.catalog.listTables(
                result_table_name.split(".")[0])
