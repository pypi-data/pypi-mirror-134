...
from py_nacos_client.utils import na_obj
...
class JdPyNacosClient(nacos.NacosClient):
    ...
    def __deregister(self, instance = None) -> None:
        ...
        map(do_deregister, self.Register_already) if not instance else do_deregister(instance)
...
def init(instance=None) -> JdPyNacosClient:
    ...
    with __cache_clients_lock:
        ...
        client = JdPyNacosClient(instance, na_obj)
