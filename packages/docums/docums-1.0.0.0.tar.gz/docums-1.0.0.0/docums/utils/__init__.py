...
def yaml_load(source, loader=yaml.Loader):
    ...
    try:
        ...
        # objects. Some docums internal calls, sometimes in test lib, will
...
def get_themes():
    ...
    themes = {}
    builtins = pkg_resources.get_entry_map(dist='docums', group='docums.themes')

    for theme in pkg_resources.iter_entry_points(group='docums.themes'):
