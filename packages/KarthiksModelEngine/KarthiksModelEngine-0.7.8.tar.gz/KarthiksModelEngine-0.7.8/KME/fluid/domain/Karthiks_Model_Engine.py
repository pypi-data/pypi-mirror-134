print("This install requires you to download the dependency files such as OneData.")
import os
path=os.getcwd()
want= input("Do you want to proceed with the download? \n1.YES \n2.NO \n")
if want=='1':
    if 'onedata.h5' in path:
        pass
    else:
        import gdown
