...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    _show_all_models_cmd = Cmd('show_all_models')
    ...
    def get_table_list(self, cursor):
        ...
        """
        cursor.execute(self._show_all_models_cmd)
    ...
    def get_table_description(self, cursor, table_name):
        ...
        #     """ % (tbl_name,)
        table_description_cmd = Cmd('table_description', data={'table_name': tbl_name})
        cursor.execute(table_description_cmd)
        items = []
    ...
    def get_key_columns(self, cursor, table_name):
        ...
        key_columns_cmd = Cmd('key_columns', data={'table_name': tbl_name})
        key_columns = []
        cursor.execute(key_columns_cmd)
    ...
    if RemovedInDjango21Warning:
        def get_indexes(self, cursor, table_name):
            ...
            # """ % (tbl_name,)
            indexes_cmd = Cmd('indexes', data={'table_name': tbl_name})
            cursor.execute(indexes_cmd)
            indexes = {}
    ...
    def get_constraints(self, cursor, table_name):
        ...
        # ORDER BY s.RDB$FIELD_POSITION
        # """ % (tbl_name,)
        constraints_cmd = Cmd('get_constraints', data={'table_name': tbl_name})
        constraints = {}

        cursor.execute(constraints_cmd)
    ...
    def _get_field_indexes(self, cursor, table_name, field_name):
        ...
        field_indexes_cmd = Cmd('field_indexes', data={'table_name': table, 'field_name': field})
        cursor.execute(field_indexes_cmd)
