    ...
    for model in apps.get_app_config('api').get_models():
        ...
        for field in model._meta.get_fields():
            if field.name != 'comp':
                ...
                if hasattr(field, 'foreign_related_fields') and definition[model_name]['fields'][field.name]['default']:
                    definition[model_name]['fields'][field.name]['default'] = to_global_id(foreign_field.model.__name__+'Type', definition[model_name]['fields'][field.name]['default'])
