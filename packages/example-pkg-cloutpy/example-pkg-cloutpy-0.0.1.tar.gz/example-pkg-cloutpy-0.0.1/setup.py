...
setuptools.setup(
    name="example-pkg-cloutpy", # Put your username here!
    version="0.0.1", # The version of your package!
    author="clout", # Your name here!
    author_email="admin@cloutflare.tech", # Your e-mail here!
    description="Package to check if TikTok Username is available", # A short description here!
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://api.cloutflare.tech", # Link your package website here! (most commonly a GitHub repo)
