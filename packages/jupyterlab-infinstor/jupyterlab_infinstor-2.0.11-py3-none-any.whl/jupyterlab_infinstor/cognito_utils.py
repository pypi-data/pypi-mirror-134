...
def bootstrap_config_values_from_mlflow_rest_if_needed():
    # There is a serious gotcha here. builtins may get initialized by infinstor_mlflow_plugin
    # which does not know or use the variable infinstor_time_spec. So we init
    # server extension specific vars here
