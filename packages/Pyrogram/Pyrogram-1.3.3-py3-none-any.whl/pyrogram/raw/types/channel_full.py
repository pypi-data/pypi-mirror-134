...
class ChannelFull(TLObject):  # type: ignore
    ...
    def read(b: BytesIO, *args: Any) -> "ChannelFull":
        ...
        pending_suggestions = TLObject.read(b, String) if flags & (1 << 25) else None
        ...
        recent_requesters = TLObject.read(b, Long) if flags & (1 << 28) else None
        
        default_send_as = TLObject.read(b) if flags & (1 << 29) else None
        
        available_reactions = TLObject.read(b, String) if flags & (1 << 30) else None
