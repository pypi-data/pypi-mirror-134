...
class ResponseModelDetail(object):
    ...
    def __init__(self, artifact_volume_id=None, created_by=None, created_dt=None, experiment=None, id=None, metrics_summary=None, model_repository=None, name=None, number=None, status=None, status_reason=None, tags=None, updated_dt=None, local_vars_configuration=None):  # noqa: E501
