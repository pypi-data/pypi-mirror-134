...
class OrmProjectEdges(object):
    ...
    def __init__(self, experiments=None, organization=None, primary_owner=None, repositories=None, tag_group=None, volume=None, local_vars_configuration=None):  # noqa: E501
