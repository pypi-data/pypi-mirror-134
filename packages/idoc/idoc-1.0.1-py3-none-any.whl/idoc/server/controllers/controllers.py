...
from idoc.server.hardware.interfaces import DefaultInterface
...
MAPPINGS_FOLDER = IDOCConfiguration().content["folders"]["mappings"]["path"]
PARADIGMS_FOLDER = IDOCConfiguration().content["folders"]["mappings"]["path"]
DEFAULT_MAPPING = os.path.join(PARADIGMS_FOLDER, "mega.csv")
DEFAULT_PARADIGM = os.path.join(PARADIGMS_FOLDER, "warm_up.csv")
...
class Controller(DefaultInterface, Base, Root):
    ...
    def __init__(
        ...
        self._mapping_path = mapping_path or DEFAULT_MAPPING
        ...
        self.paradigm_path = paradigm_path or DEFAULT_PARADIGM
...
if __name__ == "__main__":
    ...
    controller = Controller(
        ...
        paradigm_path=DEFAULT_PARADIGM,
