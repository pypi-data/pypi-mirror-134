...
`,z=e=>{let t;switch(e){case"file-path":t="file";break;case"directory-path":t="directory";break;default:t="path"}return t},S=m()((({id:e,label:t,format:n,description:a,defaultValue:r,pattern:o,error:l,onChange:s,className:d})=>{const[p,m]=(0,i.useState)(""),[u,f]=(0,i.useState)(null),[g,b]=(0,i.useState)("/"),[x,w]=(0,i.useState)([]),[E,v]=(0,i.useState)(!1),j=(0,i.useRef)(null),N=[];l&&N.push(l),u&&N.push(u),(0,i.useEffect)((()=>{(async()=>{const e=await(async e=>{const t=encodeURIComponent(e);return(await h(`directory/${t}?contents=true`,{method:"GET"})).contents})(g);w(e)})()}),[g]);return c().createElement("div",{className:`FileInput ${d}`},c().createElement("h4",null,t),c().createElement("p",null,a),c().createElement("div",{className:"file-input-container"},c().createElement("label",{htmlFor:e},c().createElement("input",{id:e,ref:j,type:"text",placeholder:"Enter a value",defaultValue:r,pattern:o,onChange:t=>{(async(t,n)=>{if(""===t)return void s(e,n,t);const a=encodeURIComponent(t),r=await h(`${n}/${a}`,{method:"GET"});r.exists?(f(null),s(e,n,t)):f(r.error)})(t.target.value,z(n))}})),c().createElement("button",{className:"file-browser-toggle",onClick:()=>v(!E)},"Browse")),E?c().createElement("div",{className:"file-browser"},c().createElement("ul",null,"/"!==g?c().createElement("li",{className:"file-browser-path file-browser-back"},c().createElement("button",{onClick:()=>b((e=>{const t=e.split("/").slice(0,-1).join("/");return""===t?"/":t})(g))},"Go Up")):"",x.map((e=>c().createElement("li",{className:"file-browser-path"},c().createElement("button",{onClick:()=>((e,t,a)=>{if(e===p)return;if(!t&&"directory"===z(n))return;if(t&&"file"===z(n))return;m(e);const r=a.current;if(r){((e,t)=>{var n,a;const r=null===(n=Object.getOwnPropertyDescriptor(e,"value"))||void 0===n?void 0:n.set,o=Object.getPrototypeOf(e),l=null===(a=Object.getOwnPropertyDescriptor(o,"value"))||void 0===a?void 0:a.set;r&&r!==l?null==l||l.call(e,t):null==r||r.call(e,t)})(r,e);const t=new Event("input",{bubbles:!0});r.dispatchEvent(t)}})(e.path,e.dir,j),onDoubleClick:()=>{return t=e.path,void(e.dir&&b(t));var t}},c().createElement(k.FontAwesomeIcon,{icon:e.dir?y.faFolder:y.faFile}),e.name)))))):"",N.length?c().createElement("div",{className:"error"},N.map((e=>c().createElement("p",null,"Error: ",e)))):"")}))`
  h4 {
    padding: 0 0 5px 0;
    font-size: 12px;
    font-weight: bold;
...
`,A=P,G=m()((({className:e})=>c().createElement("div",{className:`instances-panel ${e}`},c().createElement($,{title:"History"}),c().createElement("div",{className:"instances-panel-section"},c().createElement(A,null)))))`
  background-color: #f6f6f6;
  padding-bottom: 100px;
