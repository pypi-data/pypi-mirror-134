...
class TestPigeonHole(TestCase):
    def setUp(self) -> None:
        ...
        self.ph_alice = PigeonHole(self.query_keys.public, compute_dhke(self.query_keys.private, self.bob_keys.public))
        self.ph_bob = PigeonHole(self.query_keys.public, compute_dhke(self.bob_keys.private, self.query_keys.public))
