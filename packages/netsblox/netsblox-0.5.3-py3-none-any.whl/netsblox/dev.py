...
class Geolocation:
    ...
    def street_address(self, address: str) -> str:
        ...
        '''
        res = self._client._call('Geolocation', 'streetAddress', { 'address': address })
        return str(res)
    def timezone(self, address: Any) -> dict:
        ...
        '''
        res = self._client._call('Geolocation', 'timezone', { 'address': address })
        return dict(res)
class GoogleMaps:
    '''
    The GoogleMaps Service provides access to the Google Maps API along with helper functions for interacting with the maps (such as converting coordinates).
...
class NewYorkTimes:
    ...
    def get_concept_info(self, concept: dict) -> dict:
        ...
        :returns: 
        '''
        res = self._client._call('NewYorkTimes', 'getConceptInfo', { 'concept': concept })
        return dict(res)
...
class RoboScape:
    ...
    def get_robots(self) -> List[str]:
        ...
        :returns: 
        '''
        res = self._client._call('RoboScape', 'getRobots', {  })
        return _common.vectorize(str)(res)
    def get_ticks(self, robot: str) -> List[int]:
        ...
        '''
        res = self._client._call('RoboScape', 'getTicks', { 'robot': robot })
