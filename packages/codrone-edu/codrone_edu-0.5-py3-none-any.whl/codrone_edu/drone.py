...
class Drone:
    ...
    def turn_degree(self,degree, timeout=3):
        """
        Turns right or left relative to drone's current heading.
        Positive degrees turn to right and negative degrees turn to the left.
    ...
    def set_trim(self, roll, pitch, yaw, throttle):
        ...
        :param yaw: integer from -100-100
        :param throttle: integer from -100-100
        :return: None
        """
    ...
    def add_color(self,label,data,dataset):
        ...
        if not os.path.isdir(path):
            ...
            print("Dataset " + dataset + " already exists.")
            answer = input("Add anyway? (y/n)")
