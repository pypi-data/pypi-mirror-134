...
def update():
    ...
    if old_date == target_date:
        ...
        print('开始保存数据')
        # new_etf.to_excel('etf_50_data_wind.xlsx')
        # df_final.to_excel('option_50_data_wind.xlsx')
        new_etf.to_hdf('etf_50_data_wind.h5',key='etf_50')
        df_final.to_hdf('option_50_data_wind.h5',key='option_50')
        print('保存成功!')
