...
class DetailsModel(Model):
	...
	def format_untracked(self, pattern, filenames):
		return [([(settings.COLOR_DETAILS_UNTRACKED, utils.colored_str_to_markup(formatter.format(pattern, filename=fn), self.app.define_color))], TYPE_UNTRACKED, FileInfo(fn)) for fn in filenames]
