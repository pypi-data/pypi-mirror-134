...
class Database:
    ...
    def get_us_earning_calendar(self, code):

        link_url = 'http://www.hkfdb.net/data_api?'
        token_str = 'token=' + str(self.authToken)
        database_str = 'database=' + 'us_earning_calendar'
        code_str = 'code=' + code
    ...
    def get_north_water(self, start_date, end_date):
        ...
        check_bool_dict = self.check_north_water_args(start_date, end_date)
    ...
    def check_north_water_args(self, start_date, end_date):
