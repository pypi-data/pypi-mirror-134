...
l0_pipeline.add_node(task=QualityL0Metrics, upstreams=TransferL0Data)
l0_pipeline.add_node(task=ParseL0VbiInputData, upstreams=QualityL0Metrics)
...
l0_pipeline.add_node(task=SubmitQuality, upstreams=QualityL1Metrics)
