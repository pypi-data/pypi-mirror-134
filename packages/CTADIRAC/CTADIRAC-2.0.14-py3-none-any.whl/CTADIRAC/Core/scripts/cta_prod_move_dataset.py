...
to a given dest SE to be passed as an argument, e.g. CC-IN2P3-Tape

Usage:
cta-prod-move-dataset [options] <dataset name or ascii file with a list of datasets> <dest SE>
...
Example:
Prod4_Paranal_gamma_North_20deg_SSTOnly_MC0 CC-IN2P3-Tape 100 test
'''
