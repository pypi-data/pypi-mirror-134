      ...
      <div class="col-xl-9 d-xl-flex justify-content-end">
        <div class="btn-toolbar btn-group-sm">
          ...
          <button type="button"
            ...
            <span v-if="showTree">
              <i class="fas fa-pencil-alt"></i> {{ $t('Editor view') }}
            </span>
            <span v-else>
              <i class="fas fa-list"></i> {{ $t('Tree view') }}
            </span>
          </button>
          <button type="button"
                  class="btn btn-link"
                  ...
                  v-if="!isTemplate">
            <span>
              <i class="fas fa-check"></i> {{ $t('Validation') }}
            </span>
          </button>
        </div>
