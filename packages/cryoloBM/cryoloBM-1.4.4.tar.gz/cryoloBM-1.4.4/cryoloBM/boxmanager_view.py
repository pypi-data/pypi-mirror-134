"""
In this file the 'Boxmanager_view' class for defining the view of the 'model-view-controller' paradigma is create
The 'Boxmanager_view' is derived by 'Boxmanager_view_ABC' class
"""
