...
#         s for s in [
#             *list(cli.constants.state_abbrev_to_pretty.keys()),
#             *list(cli.constants.state_abbrev_to_pretty.values())
#             ]
...
#         _ = {
#             "address":
#         populated = [field for field in [address, city, state, zipcode, country] if field is not None]
