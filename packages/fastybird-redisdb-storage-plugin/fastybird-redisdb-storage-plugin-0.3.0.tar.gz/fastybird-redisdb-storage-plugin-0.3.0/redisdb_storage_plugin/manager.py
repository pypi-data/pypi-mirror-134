...
from redisdb_storage_plugin.logger import Logger
...
class StorageManager(ABC):
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        self.__connection = Redis(host=host, port=port, db=database)
...
class StorageManagerFactory:  # pylint: disable=too-few-public-methods
    ...
    def create(self, host: str, port: int, database: int, entity: Type[StorageItem] = StorageItem) -> StorageManager:
