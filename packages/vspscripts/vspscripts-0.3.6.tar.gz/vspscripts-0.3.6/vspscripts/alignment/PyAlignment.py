...
if __name__ == "__main__":
    ...
    if gol.get_value('IS_PRINT'):
        ...
        func = partial(alignment_imgcam, img_path, cam_path, args.output_dir, args.out_size)
        print('time Usage {} s'.format(timeit(func, number = 1)))
    else:
        _, _, _, M_Sim, _ = alignment_imgcam(img_path, cam_path, args.output_dir, args.out_size)
        print(M_Sim)
