            ...
            for frame in frames:
                for quality_task_type_datum in quality_task_type_data:
                    if frame.ip_task_type == quality_task_type_datum.quality_task_type:
                        ...
                        rms = np.sqrt(np.nanmean(frame.data ** 2))
                        ...
                        logger.info(f"{rms=}")
                        logger.info(f"{normalization_factor=}")
                        ...
                        logger.info(f"{data_has_nans=}")
                        logger.info(f"{num_nans=}")
                        logger.info(f"{data_is_all_zeros=}")
                        logger.info(f"{array_size=}")
                        if normalized_rms == float("nan"):
                            logger.info(f"BAD FRAME: {frame.header}")
